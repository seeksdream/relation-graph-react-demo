...
var pt = (t, i, e) => i in t ? ae(t, i, { enumerable: !0, configurable: !0, writable: !0, value: e }) : t[i] = e, kt = (t, i) => {
  for (var e in i || (i = {}))
    ce.call(i, e) && pt(t, e, i[e]);
  if (bt)
    for (var e of bt(i))
      he.call(i, e) && pt(t, e, i[e]);
  return t;
}, St = (t, i) => re(t, le(i));
var g = (t, i, e) => (pt(t, typeof i != "symbol" ? i + "" : i, e), e);
var x = (t, i, e) => new Promise((o, n) => {
  var s = (r) => {
    try {
      l(e.next(r));
    } catch (c) {
...
(function(t) {
  ...
  i = function() {
    var u, f, h, _;
    (_ = document.createElement("div")).innerHTML = l, l = null, (h = _.getElementsByTagName("svg")[0]) && (h.setAttribute("aria-hidden", "true"), h.style.position = "absolute", h.style.width = 0, h.style.height = 0, h.style.overflow = "hidden", u = h, (f = document.body).firstChild ? (_ = u, (h = f.firstChild).parentNode.insertBefore(_, h)) : f.appendChild(u));
  ...
  }, document.addEventListener("DOMContentLoaded", e, !1)) : document.attachEvent && (o = i, n = t.document, s = !1, (a = function() {
    try {
...
const de = (t) => (t = t.replace("#", ""), t = t.replace("(", ""), t = t.replace(")", ""), t = t.replace(/,/, "-"), t), q = (t) => {
  try {
    if ("touches" in t && t.touches || "targetTouches" in t && t.targetTouches)
      return !0;
  } catch (i) {
  }
  return !1;
}, _t = (t) => t instanceof TouchEvent ? {
  ...
  typeof window != "undefined" && window.relationGraphDebug && console.log("[relation-graph:debug]", ...t);
}, yt = (t, i, e) => t ? t.classList.contains(i) ? t : t.classList.contains(e) ? null : yt(t.parentElement, i, e) : null, ue = (t) => x(void 0, null, function* () {
  return new Promise((i, e) => {
    setTimeout(() => {
      i();
    }, t);
  });
}), $ = (t) => typeof t == "string" ? Number.parseInt(t) : t, at = (t) => {
  if (t.id === void 0)
    throw console.log("node must has id:", t), new Error("node must has option[id]:");
  const i = {
    id: t.id,
    ...
    alignItems: t.alignItems !== void 0 ? t.alignItems : void 0,
    selected: t.selected !== void 0 ? t.selected : !1,
    flashing: void 0,
    styleClass: t.styleClass !== void 0 ? t.styleClass : "",
    className: t.className !== void 0 ? t.className : "",
    targetNodes: [],
    targetFrom: [],
    targetTo: [],
  ...
  return Object.keys(t).forEach((e) => {
    fe.includes(e) || t[e] !== void 0 && (i[e] = t[e]);
  }), i;
}, pe = {
  json2Node: at,
  transNodeToJson: vt
  ...
  if (t.from === void 0)
    throw console.log("error,line must has option[from]:", t), new Error("error,line must has option[from]:");
  if (t.to === void 0)
    throw console.log("error,line must has option[to]:", t), new Error("error,line must has option[to]:");
  if (typeof t.from != "string")
    throw console.log("error line from, must be string:", t), new TypeError("error line from, must be string:");
  if (typeof t.to != "string")
    throw console.log("error line to, must be string:", t), new TypeError("error line to, must be string:");
  const i = {
    from: t.from,
    to: t.to,
    text: t.text !== void 0 ? t.text : "",
    textOffset_x: t.textOffset_x !== void 0 ? t.textOffset_x : void 0,
    textOffset_y: t.textOffset_y !== void 0 ? t.textOffset_y : void 0,
    color: t.color !== void 0 ? t.color : void 0,
    opacity: t.opacity !== void 0 ? t.opacity : 1,
    fontColor: t.fontColor !== void 0 ? t.fontColor : void 0,
    ...
    animation: t.animation !== void 0 ? t.animation : 0,
    dashType: t.dashType !== void 0 ? t.dashType : 0,
    ...
    useTextPath: t.useTextPath !== void 0 ? t.useTextPath : void 0,
    forDisplayOnly: t.forDisplayOnly || t.from === t.to,
    fromJunctionPoint: t.fromJunctionPoint,
    toJunctionPoint: t.toJunctionPoint,
...
}, me = ["arrow", "id", "reverseText", "isReverse"], xt = (t, i) => {
  !t || t.relations.forEach((e) => {
    const o = {};
    Object.keys(e).forEach((n) => {
      me.includes(n) || e[n] !== void 0 && (o[n] = e[n]);
    }), i.push(o);
  });
}, W = {
  border: "border",
  ...
  analysisNodes(t, i, e, o) {
    i.length > o.max_length && (o.max_length = i.length), e > o.max_deep && (o.max_deep = e);
    const n = {
      level: e,
      all_size: i.length,
      all_strength: 0
    ...
    const s = [];
    i.forEach((a) => {
      t.push(a), a.targetNodes && a.targetNodes.forEach((l) => {
        t.includes(l) || (t.push(l), l.lot.parent = a, s.push(l));
      });
    }), n.all_strength > o.max_strength && (o.max_strength = n.all_strength), s.length > 0 && m.analysisNodes(t, s, e + 1, o);
  },
  analysisNodes4Didirectional(t, i, e, o, n) {
    i.length > o.max_length && (o.max_length = i.length), e > o.max_deep && (o.max_deep = e);
    const s = {
      level: e,
      all_size: i.length,
    ...
    i.forEach((r) => {
      r.lot || (r.lot = { childs: [] }), r.lot.eached = !0, r.lot.subling = s, r.lot.level = e, t.push(r);
    });
    let l = 0;
    i.forEach((r) => {
      let c = 0;
      if (n === 0) {
        ...
        r.targetNodes.forEach((f) => {
          f.lot || (f.lot = { eached: !1, childs: [] }), f.lot.eached || (m.isAllowShowNode(f) ? (f.lot.eached = !0, f.lot.parent = r, f.lot.index_of_parent = u++, r.lot.childs.push(f), a.push(f), c++) : r.lot.childs.push(f));
        });
      } else if (n === -1) {
        let u = 0;
    ...
    }), s.all_strength > o.max_strength && (o.max_strength = s.all_strength), a.length > 0 ? m.analysisNodes4Didirectional(t, a, e + (n === -1 ? -1 : 1), o, n) : (t.forEach((r) => {
    ...
    }), m.analysisDataTree([t[0]], 0, n));
  },
  conductStrengthToParents(t) {
    t.lot.parent && Math.abs(t.lot.level) - 1 === Math.abs(t.lot.parent.lot.level) && (t.lot.parent.lot.strengthWithChilds += 1, m.conductStrengthToParents(t.lot.parent));
  },
  analysisDataTree(t, i, e) {
    e === void 0 && (e = 1);
    const o = [];
    let n = 0;
    t.forEach((s) => {
    ...
    }), o.length > 0 && m.analysisDataTree(o, i + e, e);
  },
  isAllowShowNode(t, i = 0) {
    return i > 15 ? !0 : (!t.lot || !t.lot.parent || m.isAllowShowNode(t.lot.parent, i + 1) && t.lot.parent.expanded !== !1) && t.isShow && t.isHide !== !0;
  },
  getNodeWidth(t, i) {
    return t.el.offsetWidth || t.width || i && i.defaultNodeWidth || 50;
  },
  getNodeHeight(t, i) {
    return t.el.offsetHeight || t.height || i && i.defaultNodeHeight || 50;
  },
  getNodeXByLotX(t, i) {
    return (i.offset_x || 0) + this.getNodeXByCenterX(t, i, i.lot.x || 0);
  },
  getNodeYByLotY(t, i) {
    return (i.offset_y || 0) + this.getNodeYByCenterY(t, i, i.lot.y || 0);
  },
  getNodeXByCenterX(t, i, e) {
    return i.alignItems === "right" ? e - m.getNodeWidth(i, t) : i.alignItems === "left" ? e : e - m.getNodeWidth(i, t) / 2;
  },
  getNodeYByCenterY(t, i, e) {
    return i.alignItems === "top" ? e : i.alignItems === "bottom" ? e - m.getNodeHeight(i, t) : e - m.getNodeHeight(i, t) / 2;
  },
  getCenterXByNodeX(t, i, e) {
    return e + m.getNodeHeight(i, t) / 2;
  },
  getCenterYByNodeY(t, i, e) {
    return e + m.getNodeHeight(i, t) / 2;
  },
  getLotXByNodeX(t, i) {
    const e = i.offset_x || 0;
    return this.getCenterXByNodeX(t, i, i.x || 0) - e;
  },
  getLotYByNodeY(t, i) {
    const e = i.offset_y || 0;
    return this.getCenterYByNodeY(t, i, i.y || 0) - e;
  }
...
class rt {
  constructor(i, e) {
    g(this, "graphOptions");
    g(this, "layoutOptions");
    g(this, "allNodes", []);
    g(this, "isMainLayouer", !0);
    g(this, "requireLinks", !1);
    g(this, "allLinks", []);
    g(this, "rootNode");
    g(this, "currentAnimationStep", 1);
    g(this, "allAnimationStep", 30);
  ...
  animationLayout(i = !0) {
    return x(this, null, function* () {
      ...
      e && d("debug0910:create rootNode coordinates:2.1", e.x, e.y), this.currentAnimationStep = 1, this.allAnimationStep = 10, d("[LayoutAnimationEffect]start play...");
      let o = !1;
  ...
  playAnimation(i) {
    ...
    this.allNodes.forEach((e) => {
      if (!e.lot.placed)
        return;
      const { from_x: o, from_y: n, to_x: s, to_y: a } = e.lot;
      if (o !== void 0 && n !== void 0 && s !== void 0 && a !== void 0) {
        const l = (s - o) / this.allAnimationStep, r = (a - n) / this.allAnimationStep, c = Math.floor(o + this.currentAnimationStep * l), u = Math.floor(n + this.currentAnimationStep * r);
        (e.x !== c || e.y !== u) && (e.x = c, e.y = u);
      }
...
class Yt extends rt {
  ...
  analysisNodes4Didirectional(e, o, n, s, a) {
    ...
    o.forEach((u) => {
      u.lot || (u.lot = { childs: [] }), u.lot.eached = !0, u.lot.subling = l, u.lot.level = n, e.push(u);
    });
    let c = 0;
    o.forEach((u) => {
      let f = 0, h = a === -1 ? u.targetFrom : u.targetTo;
      n !== 0 && (h = u.targetNodes);
      let _ = 0;
      h.forEach((p) => {
        p.lot || (p.lot = { eached: !1, childs: [] }), p.lot.eached || (p.lot.parent = u, m.isAllowShowNode(p) ? (p.lot.eached = !0, p.lot.index_of_parent = _++, u.lot.childs.push(p), r.push(p), f++) : u.lot.childs.push(p));
      }), u.lot.strength = f > 0 ? f : 1, l.all_strength += u.lot.strength, u.lot.strength_plus = l.all_strength, u.lot.index_of_level = c, u.lot.childs_size = f, c++;
    }), l.all_strength > s.max_strength && (s.max_strength = l.all_strength), r.length > 0 ? this.analysisNodes4Didirectional(e, r, n + a, s, a) : (e.forEach((u) => {
      u.lot.childs_size > 0 && (u.lot.strengthWithChilds = 0);
    }), e.forEach((u) => {
      u.lot.childs_size === 0 && (u.lot.strengthWithChilds = 1, m.conductStrengthToParents(u));
    }), m.analysisDataTree([e[0]], 0, a));
  }
  placeNodes(e, o) {
    return x(this, null, function* () {
      ...
      this.rootNode = o, this.allNodes = e, d("allNodes:", e.length), e.forEach((a) => {
  ...
  placeNodesPosition(e, o, n) {
    if (e.fixed !== !0) {
      ...
      e.origin_x === void 0 && (e.origin_x = e.x, e.origin_y = e.y), e.lot.x = e.origin_x, e.lot.y = e.origin_y, d("\u56FA\u5B9A\u4F4D\u7F6E\u7684rootNode:", e.text, e.x, e.y);
    e.lot.placed = !0, this.placeRelativePosition(e, o, n);
  }
  placeRelativePosition(e, o, n) {
    const s = this.graphOptions.viewSize;
    if (this.layoutOptions.from === "left" || this.layoutOptions.from === "right") {
      const a = $(this.layoutOptions.min_per_height) || 80, l = $(this.layoutOptions.max_per_height) || 400, r = $(this.layoutOptions.min_per_width) || 430, c = $(this.layoutOptions.max_per_width) || 650;
      let u = Math.round((s.width - 10) / (n.max_deep + 2));
      u < r && (u = r), u > c && (u = c);
      let f = Math.round(s.height / (n.max_strength + 1));
      f < a && (f = a), f > l && (f = l), o.forEach((h) => {
        h.fixed !== !0 && h.lot.placed !== !0 && h !== e && (this.layoutOptions.from === "right" ? h.lot.x = e.lot.x - this.getLevelDistance(h, h.lot.subling.level, u) : h.lot.x = e.lot.x + this.getLevelDistance(h, h.lot.subling.level, u));
      }), o.forEach((h) => {
        h.fixed !== !0 && h.lot.level !== 0 && (h.lot.y = e.lot.y + f * (n.max_strength / -2 + h.lot.strengthWithChilds_from + h.lot.strengthWithChilds / 2));
      }), this.gatherNodes(o, "h", f);
    } else {
      const a = $(this.layoutOptions.min_per_height) || 350, l = $(this.layoutOptions.max_per_height) || 400, r = $(this.layoutOptions.min_per_width) || 250, c = $(this.layoutOptions.max_per_width) || 500;
      let u = Math.round((s.width - 10) / (n.max_strength + 2));
      u < r && (u = r), u > c && (u = c);
      let f = Math.round((s.height - 10) / (n.max_deep + 2));
      f < a && (f = a), f > l && (f = l), o.forEach((h) => {
        h.fixed !== !0 && h.lot.placed !== !0 && h !== e && (this.layoutOptions.from === "bottom" ? h.lot.y = e.lot.y - this.getLevelDistance(h, h.lot.subling.level, f) : h.lot.y = e.lot.y + this.getLevelDistance(h, h.lot.subling.level, f));
      }), o.forEach((h) => {
        h.fixed !== !0 && h.lot.level !== 0 && (h.lot.x = e.lot.x + u * (n.max_strength / -2 + h.lot.strengthWithChilds_from + h.lot.strengthWithChilds / 2));
      }), this.gatherNodes(o, "v", u);
    }
  }
  gatherNodes(e, o, n) {
    ...
    e.forEach((a) => {
      ...
      if (a.fixed !== !0 && a.lot.level !== 0) {
        ...
        if (a.lot.strengthWithChilds === 1 && a.lot.childs_size <= 1) {
          ...
          c && (console.log(a.text, "bloomingNode:", c.text, c.lot.y, n), o === "h" ? a.lot.y - c.lot.y > 0 ? (a.lot.y = c.lot.y + n * c.lot.movedNodeSizeAfter, c.lot.movedNodeSizeAfter++) : (a.lot.y = c.lot.y - n * c.lot.movedNodeSizeBefore, c.lot.movedNodeSizeBefore++) : a.lot.x - c.lot.x > 0 ? (a.lot.x = c.lot.x + n * c.lot.movedNodeSizeAfter, c.lot.movedNodeSizeAfter++) : (a.lot.x = c.lot.x - n * c.lot.movedNodeSizeBefore, c.lot.movedNodeSizeBefore++));
        }
      }
    });
  }
  getBloomingNearByParent(e, o, n, s) {
    let a = 9999, l;
    for (const r of n)
...
const Mt = 0, B = {
  getRectPoint(t, i, e, o, n, s, a, l, r = !1, c = 1, u = 1) {
    r && (u = c - u - 1);
    const f = 40 / (c + 1) * (u + 1) - 20, h = t + n / 2, _ = i + s / 2, p = e + a / 2, y = o + l / 2, v = h < p ? 1 : -1, b = _ < y ? 1 : -1;
    if (y === _)
      return { x: h + v * n / 2, y: _ };
    const S = Math.abs((p - h) / (y - _)), L = n / s;
    let G = 0, E = 0;
    return S < L ? (G = v * s / 2 * S + b * f * L, E = b * s / 2) : (G = v * n / 2, E = b * n / 2 / S + v * f * L), { x: h + G, y: _ + E };
  },
  getRectPointBasic(t, i, e, o, n, s, a, l) {
    const r = t + n / 2, c = i + s / 2, u = e + a / 2, f = o + l / 2;
    let h = f === c ? 0 : (u - r) / (f - c);
    h === 0 && (h = (u - r) / (f - c + 1));
    const _ = n / l;
    let p = 0, y = 0, v = "1";
    return -1 * _ < h && h < _ ? (v = "2", c < f ? (p = s / 2 * h, y = s / 2) : (p = -1 * s / 2 * h, y = -1 * s / 2)) : (r < u ? (p = 1 * n / 2, y = 1 * n / 2 / h) : (p = -1 * n / 2, y = -1 * n / 2 / h), v = "3"), { x: r + p, y: c + y, _case: v };
  },
  getRectJoinPoint(t, i, e, o, n, s, a, l) {
    const r = t + n / 2, c = i + s / 2, u = e + a / 2, f = o + l / 2, h = Math.round(Math.atan2(f - c, u - r) * 180 / 3.14) + 135;
    return h >= 0 && h < 90 ? { x: t + n / 2, y: i - 5 } : h >= 90 && h < 180 ? { x: t + n + 5, y: i + s / 2 } : h >= 180 && h < 270 ? { x: t + n / 2, y: i + s + 5 } : { x: t - 5, y: i + s / 2 };
  },
  getRectHJoinPoint(t, i, e, o, n, s, a) {
    const l = s / 2;
    return t + n < e ? { x: t + n + 5, y: i + l } : t + n < e + a ? { x: t - 5, y: i + l } : { x: t - 5, y: i + l };
  },
  getRectLeftJoinPoint(t, i, e, o, n, s, a) {
    const l = s / 2;
    return { x: t - 5, y: i + l };
  },
  getRectRightJoinPoint(t, i, e, o, n, s, a) {
    const l = s / 2;
    return { x: t + n + 5, y: i + l };
  },
  getRectTopJoinPoint(t, i, e, o, n, s, a) {
    return { x: t + n / 2, y: i - 5 };
  },
  getRectBottomJoinPoint(t, i, e, o, n, s, a) {
    return { x: t + n / 2, y: i + s + 5 };
  },
  getRectVJoinPoint(t, i, e, o, n, s, a, l) {
    const r = n / 2;
    return i + s < o ? { y: i + s + 5, x: t + r } : i + s < o + l ? { y: i - 5, x: t + r } : { y: i - 5, x: t + r };
  },
  getBorderPoint(t, i, e, o, n, s, a, l, r) {
    return r === 0 ? this.getCirclePoint(t, i, e, o, n, s, a, l) : this.getRectPoint(t, i, e, o, n, s, a, l);
  },
  getBorderPoint4MultiLine(t, i, e, o, n, s, a, l, r, c, u, f) {
    return r === 0 ? this.getCirclePoint4MultiLine(t, i, e, o, n, s, a, l, c, u, f) : this.getRectPoint(t, i, e, o, n, s, a, l, c, u, f);
  },
  getCirclePoint(t, i, e, o, n, s, a, l) {
    const r = e + a / 2, c = o + l / 2, u = t + n / 2, f = i + s / 2, h = r - u;
    if (h === 0)
      return { x: u, y: f - s / 2 * (c < f ? 1 : -1) };
    const p = (c - f) / h, y = Math.sqrt(1 / (1 / (n / 2) ** 2 + p ** 2 / (s / 2) ** 2)) * (r < u ? 1 : -1), v = p * y;
    return { x: u - y, y: f - v };
  },
  getCirclePoint4MultiLine(t, i, e, o, n, s, a, l, r, c, u) {
    r && (u = c - u - 1);
    const f = e + a / 2, h = o + l / 2, _ = t + n / 2, p = i + s / 2, y = f - _;
    if (y === 0)
      return { x: _, y: p - s / 2 * (h < p ? 1 : -1) };
    const v = 40 / (c + 1) * (u + 1) - 20, b = h - p, S = Math.sqrt(y ** 2 + b ** 2) * v / y, L = b / y, G = n / 2, E = s / 2, N = f < _ ? 1 : -1, X = (-1 * G ** 2 * L * S + G * E * Math.sqrt(E ** 2 + L ** 2 * G ** 2 - S ** 2) / N) / (E ** 2 + G ** 2 * L ** 2), w = L * X + S;
    return { x: _ - X, y: p - w };
  },
  getCirclePointBasic(t, i, e, o, n, s, a, l, r) {
    const c = t + n / 2, u = i + s / 2, f = e + a / 2, h = o + l / 2, _ = f - c, p = h - u, y = Math.sqrt(_ * _ + p * p), v = y - r, b = v * _ / y * -1, S = v * p / y * -1;
    return { x: f + b, y: h + S };
  },
  getCirclePointPlus(t, i, e, o, n, s, a, l) {
    const r = t + n / 2, c = i + s / 2, u = e + a / 2, f = o + l / 2, h = u - r, _ = f - c, p = Math.sqrt(h * h + _ * _), y = (p - n / 2) * h / p * -1, v = (p - s / 2) * _ / p * -1;
    return { x: u + y, y: f + v };
  },
  getOvalPoint(t, i, e, o, n) {
    return {
      x: t + e * Math.sin((Mt + o * (360 / n) + 0) * Math.PI / 180),
      y: i + e * Math.cos((Mt + o * (360 / n) + 0) * Math.PI / 180) * -1
    };
  },
  getAngleType(t, i) {
    if (t >= 0 && i >= 0)
  ...
  getTextAngle(t, i, e, o) {
    let n = Math.atan2(o - i, e - t) * 180 / Math.PI;
    return n < 0 && (n += 360), n > 90 && n <= 270 && (n += 180), n >= 360 && (n -= 360), Math.round(n);
  },
  getTreePointFromTop(t, i, e, o, n, s) {
    return t ? {
      x: t - 300 + Math.max(600 / ((n === 1 ? 2 : n) - 1), 80) * o,
      y: i + e
    } : {
  ...
  getTreePointFromRight(t, i, e, o, n, s) {
    return t ? {
      x: t - e,
  ...
  getTreePointFromBottom(t, i, e, o, n, s) {
    return t ? {
      x: t - 300 + Math.max(600 / ((n === 1 ? 2 : n) - 1), 80) * o,
      y: i - e
    } : {
  ...
  getTreePointFromLeft(t, i, e, o, n, s) {
    return t ? {
      x: t + e,
      y: i - 200 + Math.max(400 / ((n === 1 ? 2 : n) - 1), 80) * o
    } : {
...
class it extends rt {
  constructor(e, o) {
    ...
    g(this, "layoutOptions");
    g(this, "fastStart", !1);
    g(this, "maxLayoutTimes", 300);
    g(this, "byNode", !0);
    g(this, "byLine", !0);
    g(this, "lockX", !1);
    g(this, "lockY", !1);
    g(this, "force_node_repulsion", 1);
    g(this, "force_line_elastic", 1);
    g(this, "justLayoutSingleNode", !1);
    g(this, "layoutTimes", 0);
    g(this, "prev10", []);
    g(this, "visibleNodes", []);
    g(this, "viewUpdate");
    g(this, "maxVaildLineLength", 400);
    g(this, "minVaildLineLength", 30);
    g(this, "zeroEffectNodeDistance", 400);
    g(this, "minNodeDistance", 30);
    g(this, "maxMoveSpeed", 50);
  ...
  placeNodes(e, o) {
    ...
    if (this.allNodes = e, this.rootNode = o, this.layoutOptions.fixedRootNode) {
  ...
  easyAnalysisNodes(e) {
    ...
    return m.analysisNodes4Didirectional(o, [e], 0, n, 0), o;
  }
  easyPlaceRelativePosition(e, o) {
    o.forEach((s) => {
      if (s.lot.subling.level === 1) {
        const a = s.lot.subling;
        if (a) {
          const l = B.getOvalPoint(e.lot.x, e.lot.y, a.level * 50, s.lot.strength_plus - s.lot.strength / 2, a.all_strength);
      ...
      const a = s.lot.subling;
      if (a && a.level > 1) {
        const l = s.lot.parent.lot.strength_plus - s.lot.parent.lot.strength, c = (s.lot.parent.lot.strength_plus - l) / (s.lot.parent.lot.childs.length + 1) * (s.lot.index_of_parent + 1), u = B.getOvalPoint(e.lot.x, e.lot.y, (a.level - 1) * 40 + 50, l + c, s.lot.parent.lot.subling.all_strength);
        s.lot.x = u.x, s.lot.y = u.y;
      }
    });
  }
  updateVisibleNodes(e) {
    this.visibleNodes = [], e && (this.allNodes = e), this.allNodes.forEach((o) => {
      m.isAllowShowNode(o) && (o.Fx = 0, o.Fy = 0, o.lot ? o.lot.placed = !0 : (d("node miss lot:", o.text), o.lot = {
        placed: !0,
        childs: []
      }), this.visibleNodes.push(o));
    }), d("visibleNodes:", this.visibleNodes.length);
  }
  autoLayout(e, o) {
  ...
  doForceLayout(e) {
    ...
    if (d("this.layoutTimes:", this.layoutTimes, "of", this.maxLayoutTimes, "Current refresh rate:", o, "Hz", this.requireLinks, this.allLinks.length), this.layoutTimes > this.maxLayoutTimes) {
      this.isMainLayouer && (this.graphOptions.autoLayouting = !1);
      return;
    }
    if (this.isMainLayouer && (this.graphOptions.autoLayouting = !0), this.layoutTimes++, this.visibleNodes.forEach((n) => {
      n.Fx = 0, n.Fy = 0;
    }), this.byNode)
      for (const n in this.visibleNodes) {
        ...
        if (!(this.justLayoutSingleNode && !s.singleNode) && !s.fixed && s.lot.placed === !0)
          for (const a in this.visibleNodes) {
            const l = this.visibleNodes[a];
            l.lot.placed === !0 && n !== a && this.addGravityByNode(s, l);
          }
      }
    if (this.byLine)
      if (this.allLinks && this.allLinks.length > 0) {
        for (const n of this.allLinks)
          if (!n.forDisplayOnly) {
            const s = n.relations.reduce((a, l) => a + (l.force_elastic || 1), 0);
            (this.visibleNodes.includes(n.fromNode) || this.visibleNodes.includes(n.toNode)) && this.addElasticByLine(
              n.fromNode,
              n.toNode,
              s
            );
        ...
        for (const n of this.visibleNodes)
          n.lot.parent && this.addElasticByLine(
            n.lot.parent,
            n
          );
    for (const n in this.visibleNodes)
  ...
  getX(e) {
    const o = (e.width || e.el.offsetWidth || 60) / 2;
    return e.x + o;
  }
  getY(e) {
    const o = (e.height || e.el.offsetHeight || 60) / 2;
    return e.y + o;
  }
  addElasticByLine(e, o, n = 1) {
    let s = Math.sqrt((this.getY(e) - this.getY(o)) ** 2 + (this.getX(e) - this.getX(o)) ** 2);
    s > this.maxVaildLineLength && (s = this.maxVaildLineLength);
    const a = s < this.minVaildLineLength ? 0 : (s - this.minVaildLineLength) * 0.1 * this.force_line_elastic * n, l = a, r = a, c = (this.getX(e) - this.getX(o)) / s, u = (this.getY(e) - this.getY(o)) / s;
    this.addFtoNode(e, c * l * -1, u * l * -1), this.addFtoNode(o, c * r, u * r);
  }
  addGravityByNode(e, o) {
    const n = Math.sqrt(
      (this.getY(e) - this.getY(o)) ** 2 + (this.getX(e) - this.getX(o)) ** 2
    );
    ...
    const a = (this.getX(e) - this.getX(o)) / n, l = (this.getY(e) - this.getY(o)) / n;
    this.addFtoNode(e, a * s, l * s), this.addFtoNode(o, a * s * -1, l * s * -1);
  }
  addFtoNode(e, o, n) {
    if (this.justLayoutSingleNode && !e.singleNode || Number.isNaN(o) || Number.isNaN(n))
      return;
    o = o / (e.lot.strength || 1), n = n / (e.lot.strength || 1), o > 50 && (o = 50), n > 50 && (n = 50), o < -50 && (o = -50), n < -50 && (n = -50);
    const s = e.force_weight || 1;
    this.lockX || (e.Fx += o * (1 / s)), this.lockY || (e.Fy += n * (1 / s));
  }
  applyToNodePosition(e) {
    if (e.fixed)
      return;
    let o = Math.round(e.Fx), n = Math.round(e.Fy);
    o > this.maxMoveSpeed && (o = this.maxMoveSpeed), n > this.maxMoveSpeed && (n = this.maxMoveSpeed), o < -this.maxMoveSpeed && (o = -this.maxMoveSpeed), n < -this.maxMoveSpeed && (n = -this.maxMoveSpeed), e.x = e.x + o, e.y = e.y + n, e.Fx = 0, e.Fy = 0;
  }
}
class Zt extends it {
  constructor(e, o) {
  ...
  placeNodes(e, o) {
    return x(this, null, function* () {
      ...
      d("layout by root:", o), this.allNodes = e, this.rootNode = o, e.forEach((a) => {
      ...
      d("root position:", o.lot.x, o.lot.y), this.placeRelativePosition(this.rootNode, n, s), this.graphOptions.useAnimationWhenExpanded ? (d("Play layout animation....."), yield this.animationLayout()) : n.forEach((a) => {
        if (a.fixed === !0 || !m.isAllowShowNode(a))
          return;
        const l = a.offset_x || 0, r = a.offset_y || 0, c = -m.getNodeWidth(a, this.graphOptions) / 2, u = -m.getNodeHeight(a, this.graphOptions) / 2;
        a.x = a.lot.x + l + c, a.y = a.lot.y + r + u, a.lot.placed = !0;
      });
    });
  }
  placeRelativePosition(e, o, n) {
    const s = this.layoutOptions.distance_coefficient === void 0 ? 1 : this.layoutOptions.distance_coefficient;
    let a = Math.round((this.graphOptions.viewSize.height + this.graphOptions.viewSize.width) / n.max_deep * 0.2) * s;
    d("analyticResult:", n, a, this.layoutOptions.distance_coefficient), a < 150 * s && (a = 150 * s);
    let l = 0;
    o.forEach((c) => {
      const u = c.lot.subling;
      if (u && u.level === 1) {
        l = Math.round(u.all_size * 50 / Math.PI / 2), l < a && (l = a);
        const f = B.getOvalPoint(e.lot.x, e.lot.y, u.level * l, c.lot.strength_plus - c.lot.strength / 2, u.all_strength);
    ...
    o.forEach((c) => {
      const u = c.lot.subling;
      if (u && u.level > 1) {
        const f = c.lot.parent.lot.strength_plus - c.lot.parent.lot.strength, _ = (c.lot.parent.lot.strength_plus - f) / (c.lot.parent.lot.childs_size + 1) * (c.lot.index_of_parent + 1), p = B.getOvalPoint(e.lot.x, e.lot.y, (u.level - 1) * r + l, f + _, c.lot.parent.lot.subling.all_strength);
        c.lot.x = p.x, c.lot.y = p.y;
      }
    });
  }
}
  ...
  placeNodes(i, e) {
    return x(this, null, function* () {
      ...
      l < 200 && (l = 200), l > 800 && (l = 800), this.allNodes.forEach((r, c) => {
        const u = B.getOvalPoint(s.x, s.y, l, c, a);
        ...
        if (r.fixed === !0 || !m.isAllowShowNode(r))
          return;
        const c = r.offset_x || 0, u = r.offset_y || 0, f = -m.getNodeWidth(r, this.graphOptions) / 2, h = -m.getNodeHeight(r, this.graphOptions) / 2;
        r.x = r.lot.x + c + f, r.y = r.lot.y + u + h, r.lot.placed = !0;
      });
    });
  }
}
class qt extends rt {
  ...
  placeNodes(e, o) {
    ...
    d("allNodes:", e.length), this.__origin_nodes = e, this.rootNode = o, e.forEach((s) => {
...
class xe extends rt {
  ...
  analysisNodes4Didirectional(e, o, n, s) {
    this.analysisBothWay(e, o, n, s);
    const a = {};
    e.forEach((c) => {
      const u = c.lot.level + "";
      a[u] || (a[u] = []), a[u].push(c), c.lot.subling = {
        level: c.lot.level,
        all_size: 0,
        all_strength: 0
      };
    }), e.forEach((c) => {
      const u = c.lot.level + "", f = a[u], h = f.length;
      c.lot.index_of_level = f.indexOf(c), c.lot.subling.all_size = h, c.lot.subling.all_strength += c.lot.strength || 1, c.lot.strength_plus = c.lot.subling.all_strength;
    }), e.forEach((c) => {
      c.lot.childs_size > 0 && (c.lot.strengthWithChilds = 0);
    }), console.log("willLayoutNodes.length:", e.length), e.forEach((c) => {
    ...
    const l = Object.keys(a).map((c) => Number.parseInt(c)).sort(), r = (c) => {
      ...
      let h = 0;
      f.forEach((_) => {
        _.lot.parent && h < _.lot.parent.lot.strengthWithChilds_from && (h = _.lot.parent.lot.strengthWithChilds_from), c === 0 ? h += 1 : _.lot.strengthWithChilds_from = h, d("levels:", c, h, _.text, _.lot.strengthWithChilds), h += _.lot.strengthWithChilds;
      });
    };
    [0].forEach(r), l.filter((c) => c > 0).forEach(r), l.filter((c) => c < 0).forEach(r);
  }
  analysisBothWay(e, o, n, s) {
    ...
    o.forEach((r) => {
      r.lot || (r.lot = { childs: [] }), r.lot.eached = !0, r.lot.subling = a, r.lot.level = n, e.push(r);
    });
    let l = 0;
    o.forEach((r) => {
      let c = 0, u = 0, f = [];
      r.targetFrom.forEach((h) => {
        h.lot || (h.lot = { eached: !1, childs: [] }), h.lot.eached || (h.lot.parent = r, m.isAllowShowNode(h) ? (h.lot.eached = !0, h.lot.index_of_parent = u++, r.lot.childs.push(h), f.push(h), c++) : r.lot.childs.push(h));
      }), this.analysisBothWay(e, f, n - 1, s), f = [], r.targetTo.forEach((h) => {
        h.lot || (h.lot = { eached: !1, childs: [] }), h.lot.eached || (h.lot.parent = r, m.isAllowShowNode(h) ? (h.lot.eached = !0, h.lot.index_of_parent = u++, r.lot.childs.push(h), f.push(h), c++) : r.lot.childs.push(h));
      }), this.analysisBothWay(e, f, n + 1, s), r.lot.strength = c > 0 ? c : 1, a.all_strength += r.lot.strength, r.lot.strength_plus = a.all_strength, r.lot.index_of_level = l, r.lot.childs_size = c, l++;
  ...
  placeNodes(e, o) {
    return x(this, null, function* () {
      ...
      this.rootNode = o, this.allNodes = e, d("allNodes:", e.length), e.forEach((r) => {
      ...
      m.analysisNodes(n, [this.rootNode], 0, s), n = [], s = {
        ...
        max_length: 1,
        max_strength: 1
      }, this.analysisNodes4Didirectional(n, [this.rootNode], 0, s), this.placeNodesPosition(this.rootNode, n, s), d("allNodes:", n.length), this.graphOptions.useAnimationWhenExpanded ? (d("Play layout animation....."), yield this.animationLayout(), d("create rootNode coordinates:3", o.x, o.y)) : (this.allNodes.forEach((r) => {
        if (r.fixed === !0) {
          r.lot.placed = !0;
          return;
        }
        !m.isAllowShowNode(r) || (Number.isNaN(r.lot.x) && (d("bad lot x:", r.text, r.lot.x), r.lot.x = 0), Number.isNaN(r.lot.y) && (d("bad lot y:", r.text, r.lot.y), r.lot.y = 0), r.x = m.getNodeXByLotX(this.graphOptions, r), r.y = m.getNodeYByLotY(this.graphOptions, r), r.lot.placed = !0);
      }), d("create rootNode coordinates:1", o.x, o.y));
      const a = n.filter((r) => r.lot.level === 0), l = new it({
        layoutName: "force",
        maxLayoutTimes: 100,
  ...
  placeRelativePosition(e, o, n) {
    ...
    if (this.layoutOptions.from === "left" || this.layoutOptions.from === "right") {
      ...
      f < a && (f = a), f > l && (f = l), o.forEach((h) => {
        ...
        h.fixed !== !0 && (h.lot.level === 0 ? h !== e && (h.lot.y = e.lot.y + f * h.lot.index_of_level) : h.lot.y = e.lot.y + f * (n.max_strength / -2 + h.lot.strengthWithChilds_from + h.lot.strengthWithChilds / 2));
      });
    } else {
      const a = $(this.layoutOptions.min_per_height) || 350, l = $(this.layoutOptions.max_per_height) || 400, r = $(this.layoutOptions.min_per_width) || 250, c = $(this.layoutOptions.max_per_width) || 500;
      let u = Math.round((s.width - 10) / (n.max_strength + 2));
...
const ht = (t, i) => {
  dt(t);
  let e = null;
  if (t.layoutName === "tree" ? e = new Yt(t, i) : t.layoutName === "center" ? e = new Zt(t, i) : t.layoutName === "circle" ? e = new Jt(t, i) : t.layoutName === "force" ? e = new it(t, i) : t.layoutName === "fixed" ? e = new qt(t, i) : t.layoutName === "smart-tree" && (e = new xe(t, i)), !e)
    throw new Error("unknown layout: " + t.layoutName);
  return i.isNeedShowAutoLayoutButton = t.allowAutoLayoutIfSupport !== !1 && e.autoLayout !== void 0, e;
}, dt = (t) => {
  if (typeof t.centerOffset_x == "string" && (t.centerOffset_x = parseInt(t.centerOffset_x)), typeof t.centerOffset_y == "string" && (t.centerOffset_y = parseInt(t.centerOffset_y)), t.layoutName === "center") {
    const i = t;
  ...
  } else if (t.layoutName.includes("tree")) {
    const i = t;
    ...
    (t.layoutName === "fixed" || t.layoutName === "force") && (t.layoutDirection = void 0);
}, we = {
  createLayout: ht,
  appendDefaultOptions4Layout: dt
...
let Le = 0;
const Ct = (t) => {
  !t.backgroundImage && (t.backgroundImage = t.backgrounImage), !t.backgroundImageNoRepeat && (t.backgroundImageNoRepeat = t.backgrounImageNoRepeat), typeof t.graphOffset_x == "string" && (t.graphOffset_x = parseInt(t.graphOffset_x)), typeof t.graphOffset_y == "string" && (t.graphOffset_y = parseInt(t.graphOffset_y));
  const i = {
    instanceId: "",
    debug: !0,
    graphLoading: !1,
    ...
    creatingNodePlot: !1,
    showTemplateNode: !0,
    newNodeTemplate: at(JSON.parse(JSON.stringify(wt))),
    creatingLinePlot: !1,
    newLineTemplate: {
  ...
  if (i.newLineTemplate = st(i.newLineTemplate), t.layout && t.layouts)
    throw new Error("Graph options cannot have both layout and layouts properties !");
  const e = t.debug === !0;
  e && d("RGOptions:user instance options:", t), window && (window.relationGraphDebug = e);
...
class Se {
  constructor(i, e) {
    ...
    g(this, "listeners");
    g(this, "isReact", !1);
    g(this, "updateViewHook", () => {
    });
    this.listeners = e, this.options = ft(i), d("new RelationGraph:", this);
  }
  enableDebugLog(i) {
...
class Pe extends Me {
  constructor(e, o) {
    ...
    g(this, "seeksNodeIdIndex", 0);
    g(this, "allLineColors", []);
    g(this, "userLayouerClass");
    g(this, "layouter");
    g(this, "reactiveData");
    g(this, "disableNextLayoutAnimation", !1);
    g(this, "elLineUpdating", !1);
  }
  setReactiveData(e, o) {
    this.graphData = e, this.allLineColors = o.allLineColors, o.options = this.options, this.reactiveData = o;
  }
  setReactiveDataVue3(e, o) {
    this.graphData = e, this.allLineColors = o.allLineColors, o.options = this.options, this.reactiveData = o;
  }
  _setOptions(e) {
    const o = ft(e);
  ...
  _initLayoutByLayoutOptions(e) {
    this.options.layoutClassName = e.layoutClassName, this.options.layoutLabel = e.label, this.options.layoutName = e.layoutName, this.options.layoutDirection = e.layoutDirection, this.layouter = ht(e, this.options);
  }
  initLayouter() {
    if (this.userLayouerClass)
      ...
      d("[change layout]Create default layouter\uFF1A", this.options.layoutName), this._initLayoutByLayoutOptions(e);
    } else
  ...
  _setJsonData(e, o = !1) {
    return x(this, null, function* () {
      yield this.clearGraph(), d("set jsonData:", e), this.loadGraphJsonData(e);
    });
  }
  clearGraph() {
    return x(this, null, function* () {
  ...
  generateNewNodeId(e = 1) {
    const o = "N" + (this.graphData.nodes.length + e);
    return this.getNodeById(o) ? this.generateNewNodeId(e + 1) : (d("generateNewNodeId:", e, o), o);
  }
  loadNodes(e) {
    e.forEach((o) => {
      let n = this.graphData.nodes.find((s) => s.id === o.id);
      n || (n = at(o), n && (n.seeks_id = this.seeksNodeIdIndex++, this.graphData.nodes.push(n)));
    });
  }
  loadLines(e) {
    e.forEach((o) => {
      ...
      const l = `${s.seeks_id}-${a.seeks_id}`, r = `${a.seeks_id}-${s.seeks_id}`, c = st(o);
      let u = this.graphData.links.find((p) => p.seeks_id === l), f = !1;
      u || (u = this.graphData.links.find((p) => p.seeks_id === r), u ? f = !0 : (n = !0, u = {
        seeks_id: l,
        fromNode: s,
        toNode: a,
        appended: !1,
      ...
      let h = c.arrow;
      c.isHideArrow || (h = this.getLineArrow(c.color)), s.targetNodes || (s.targetNodes = []), a.targetNodes || (a.targetNodes = []), c.forDisplayOnly ? u.forDisplayOnly = !1 : (s.targetNodes.includes(a) || s.targetNodes.push(a), a.targetNodes.includes(s) || a.targetNodes.push(s), s.targetTo.includes(a) || s.targetTo.push(a), a.targetFrom.includes(s) || a.targetFrom.push(s));
      let _ = !1;
      for (let p = 0; p < u.relations.length; p++)
        if ((u.relations[p].id || c.id) && u.relations[p].id === c.id) {
          _ = !0;
          break;
        }
      _ === !1 && (c.id || (c.id = `${u.seeks_id}-${u.relations.length}`), c.isReverse = f, c.arrow = h, u.relations.push(c)), n && (this.graphData.links.push(u), u.appended = !1);
    });
  }
  flatNodeData(e, o, n, s) {
    e.forEach((a) => {
      n.push(a), o && s.push({
        from: o.id,
        to: a.id
      ...
      l && l.length > 0 && this.flatNodeData(l, a, n, s);
    });
  }
  loadGraphJsonData(e) {
    ...
    const o = e.nodes, n = [], s = [];
    this.flatNodeData(o, null, n, s), e.lines.forEach((a) => {
      s.push(a);
  ...
  getLineArrow(e, o = !1, n = !1) {
    const s = o ? "start-" : "";
    if (n)
      return `${this.options.instanceId}-${s}arrow-checked`;
    if (e) {
      const a = de(e);
      return this.allLineColors.map((l) => l.id).includes(a) || this.allLineColors.push({ id: a, color: e }), `${this.options.instanceId}-${s}arrow-${a}`;
    } else
  ...
  getGraphJsonOptions() {
    ...
    return Object.keys(this.options).forEach((n) => {
      o.includes(n) || (e[n] = this.options[n]);
    }), e;
  }
  printGraphJsonData() {
  ...
  getNodeById(e) {
    for (let o = 0; o < this.graphData.nodes.length; o++)
      if (this.graphData.nodes[o].id === e)
        return this.graphData.nodes[o];
  }
  getLinkById(e) {
    for (let o = 0; o < this.graphData.links.length; o++)
      if (this.graphData.links[o].seeks_id === e)
        return this.graphData.links[o];
  }
  getLinkByLineId(e) {
    for (let o = 0; o < this.graphData.links.length; o++)
      if (this.graphData.links[o].relations.findIndex((n) => n.id === e) !== -1)
        return this.graphData.links[o];
  }
  addNodes(e) {
    d("addNodes:", e), this.loadNodes(e);
  }
  addLines(e) {
    d("addLines:", e), this.loadLines(e);
  }
  addElementLines(e) {
    d("addElementLines:", e), e.forEach((o) => {
  ...
  removeElementLine(e) {
    d("removeElementLine:", e), this.removeELementLineById(e.relations[0].id);
  }
  removeELementLineById(e) {
    d("removeELementLineById:", e);
    for (let o = 0; o < this.graphData.elementLines.length; o++)
      this.graphData.elementLines[o].relations[0].id === e && (this.graphData.elementLines.splice(o, 1), o--);
  }
  updateElementLines() {
    d("updateElementLines:", this.graphData.elementLines.length), !this.elLineUpdating && (this.elLineUpdating = !0, setTimeout(() => {
      this.elLineUpdating = !1, this._updateElementLines();
    }, 50));
  }
  _updateElementLines() {
    this.graphData.elementLines.forEach((e) => {
      const o = document.getElementById(e.relations[0].from), n = document.getElementById(e.relations[0].to);
      if (!o) {
      ...
      if (this._updateElementLinePosition(o, e.fromNode), this._updateElementLinePosition(n, e.toNode), e.fromNode.el.offsetWidth === 0 && e.fromNode.el.offsetHeight === 0) {
        e.relations[0].isHide = !0;
        return;
      }
  ...
  _updateElementLinePosition(e, o) {
    const n = e.getBoundingClientRect(), s = this.$canvasDom.getBoundingClientRect();
  ...
  removeNodeById(e) {
    ...
    for (let s = 0; s < this.graphData.links.length; s++) {
      ...
      (a.fromNode.id === e || a.toNode.id === e) && (this.removeLink(a), s--, o++);
    }
    d("Removed link\uFF1A", e, o);
    let n = 0;
  ...
  removeLinkByTwoNode(e, o) {
    for (const n of this.getLinks())
      if (n.fromNode.id === e && n.toNode.id === o || n.fromNode.id === e && n.toNode.id === o) {
        this.removeLink(n);
        break;
      }
  }
  getGroupByNode(e, o = []) {
    ...
    for (const n of e.targetNodes)
      o.includes(n) || this.getGroupByNode(n, o);
    return o;
  }
  _clearItem(e, o) {
    for (let n = 0; n < e.length; n++)
      e[n] === o && (e.splice(n, 1), n--);
  }
  removeNodeRef(e, o) {
    e && (e.targetNodes && this._clearItem(e.targetNodes, o), e.targetFrom && this._clearItem(e.targetFrom, o), e.targetTo && this._clearItem(e.targetTo, o));
  }
  removeLinkById(e) {
    d("removeLinkById:", e);
    for (let o = 0; o < this.graphData.links.length; o++) {
      const n = this.graphData.links[o];
      n.seeks_id === e && (this.removeNodeRef(n.fromNode, n.toNode), this.removeNodeRef(n.toNode, n.fromNode), this.graphData.links.splice(o, 1), o--);
    }
  }
  removeLink(e) {
    d("removeLink:", e), this.removeLinkById(e.seeks_id);
  }
  removeLine(e, o) {
    d("removeLine:", e, o);
    for (let n = 0; n < e.relations.length; n++)
      e.relations[n] === o && e.relations.splice(n, 1);
    e.relations.length === 0 && this.removeLink(e);
  }
  setNodePosition(e, o, n) {
    e.x = o, e.y = n;
  }
  getGraphOffet() {
    const e = this.options.graphOffset_x || 0, o = this.options.graphOffset_y || 0;
    return {
      offset_x: e,
      offset_y: o
    };
  ...
  setCanvasCenter(e, o) {
    ...
    this.setCanvasOffset(n - e + a.offset_x, s - o + a.offset_y);
  }
  setCanvasOffset(e, o) {
  ...
  resetViewSize() {
    !this.options || (d("resetViewSize"), this.options.viewSize.width = this.$dom.getBoundingClientRect().width, this.options.viewSize.height = this.$dom.getBoundingClientRect().height, this.options.canvasZoom = 100, this.setCanvasCenter(0, 0), this.refreshNVAnalysisInfo());
  }
  ...
  getStuffSize(e) {
    const o = e || this.graphData.nodes;
    let n = 9999999, s = 9999999, a = 0, l = 0;
    o.forEach((f) => {
      m.isAllowShowNode(f) && (f.x < n && (n = f.x), f.x > a && (a = f.x + f.el.offsetWidth), f.y < s && (s = f.y), f.y > l && (l = f.y + f.el.offsetHeight));
    });
    const r = 100, c = a - n + r, u = l - s + r;
    return {
      width: c,
      height: u,
      minX: n,
  ...
  querySearchAsync(e) {
    if (d("fetch-suggestions", e), e = e.trim(), e === "")
      return;
    const o = [];
    return this.graphData.nodes.forEach((n) => {
      d("fetch:", n.text), n.text.includes(e) && o.push(n);
...
class Ee extends Pe {
  ...
  dataURLToBlob(i) {
    const e = i.split(","), o = e[0], n = o && o.match(/:(.*?);/)[1], s = atob(e[1]);
    let a = s.length;
  ...
  createGraphCanvas(i = "png") {
    return x(this, null, function* () {
      return new Promise((e, o) => {
        ...
        let u = 999999, f = 999999, h = 0, _ = 0;
        const p = 200;
        this.loading("Generating..."), this.graphData.nodes.forEach((w) => {
          w.x < u && (u = w.x), w.x > h && (h = w.x + w.el.offsetWidth), w.y < f && (f = w.y), w.y > _ && (_ = w.y + w.el.offsetHeight);
        });
        const y = u - p, v = f - p;
        this.graphData.nodes.forEach((w) => {
          ...
          const C = w;
          C.style.left = -v + "px", C.style.top = -v + "px";
        }), this.updateElementLines(), this.$canvasDom.querySelectorAll(".rel-lines-svg-el-lines").forEach((w) => {
          const C = w;
          C.style.width = "4000px", C.style.height = "4000px";
        }), this.options.canvasOffset.x = p * -1, this.options.canvasOffset.y = p * -1;
        const L = h - u + 200 + p * 2, G = _ - f + 100 + p * 2, E = window.devicePixelRatio;
        this.options.canvasSize.width = L * E, this.options.canvasSize.height = G * E, window.scrollTo(0, 0);
        const N = document.createElement("canvas");
        N.width = L * E, N.height = G * E, N.style.backgroundColor = getComputedStyle(c.parentElement, null).backgroundColor, d("canvas.style.backgroundColor:", N.style.backgroundColor), N.style.width = `${L * E}px`, N.style.height = `${G * E}px`, N.getContext("2d").scale(1, 1);
        const X = {
        ...
        setTimeout(() => {
          this.createImage(c, X, i, "", (w) => {
            this.options.canvasSize.width = s, this.options.canvasSize.height = a, this.options.canvasOffset.x = l, this.options.canvasOffset.y = r, this.options.canvasZoom = n, this.$canvasDom.querySelectorAll(".rel-canvas-slot").forEach((O) => {
              const M = O;
              M.style.left = "0px", M.style.top = "0px";
            }), this.graphData.nodes.forEach((O) => {
              O.x = O.x + y, O.y = O.y + v;
            }), this.$canvasDom.querySelectorAll(".rel-lines-svg-el-lines").forEach((O) => {
              const M = O;
              M.style.width = "1px", M.style.height = "1px";
  ...
  createImage(i, e, o, n, s) {
    d("createImage:", e), Ut(i, e).then((a) => {
      s && s(a);
    });
  }
  getImageBase64(i = "png") {
    return x(this, null, function* () {
      const e = yield this.createGraphCanvas(i), o = document.body.appendChild(e);
      o.style.display = "none";
      const n = o.toDataURL(`image/${i}`);
      return document.body.removeChild(o), n;
    });
  }
  downloadAsImage(i = "png", e) {
    return x(this, null, function* () {
      ...
      d("downloadImageAsFile:", i, e);
      let n = !0;
      this.listeners.onImageSaveAsFile && this.listeners.onImageSaveAsFile(
        o,
        i,
        e
      ) === !1 && (n = !1), n && (yield this.downloadImageAsFile(o, i, e));
    });
  }
  downloadImageAsFile(i, e, o) {
    return x(this, null, function* () {
      const n = document.body.appendChild(i);
      n.style.display = "none";
      const s = this.dataURLToBlob(n.toDataURL(`image/${e}`));
      document.body.removeChild(n);
      const a = document.createElement("a");
      a.style.display = "none";
      try {
        window.navigator.msSaveOrOpenBlob ? window.navigator.msSaveOrOpenBlob(s, `${o}.${e}`) : (a.setAttribute("href", URL.createObjectURL(s)), a.setAttribute("download", `${o}.${e}`), document.body.appendChild(a), a.click(), d("click ok!"), URL.revokeObjectURL(yield s.text()), d("revokeObjectURL ok!"), document.body.removeChild(a), d("removeChild ok!"));
      } catch (l) {
...
class Ne extends Ee {
  ...
  createLinePath(i, e, o) {
    ...
    return o || (o = 0), this.createLinePathByTwoNode(n, s, e, o, a);
  }
  _getJunctionPoint(i, e) {
    return i === W.border ? B.getBorderPoint4MultiLine(...e) : i === W.ltrb ? B.getRectJoinPoint(...e) : i === W.tb ? B.getRectVJoinPoint(...e) : i === W.lr ? B.getRectHJoinPoint(...e) : i === W.left ? B.getRectLeftJoinPoint(...e) : i === W.right ? B.getRectRightJoinPoint(...e) : i === W.top ? B.getRectTopJoinPoint(...e) : i === W.bottom ? B.getRectBottomJoinPoint(...e) : B.getBorderPoint4MultiLine(...e);
  }
  createLinePathByTwoNode(i, e, o, n = 0, s = 1) {
    const a = o.lineShape || this.options.defaultLineShape || 1, l = o.lineDirection || this.options.layoutDirection || "h";
    let r = i.x, c = i.y, u = e.x, f = e.y;
    const h = { x: 0, y: 0, rotate: 0 };
    if (Number.isNaN(r) || Number.isNaN(c))
      return d("error start node:", i.text, i.x, i.y), h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L 100 100", h);
    if (Number.isNaN(u) || Number.isNaN(f))
      return d("error end point:", e.text, e.x, e.y), h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L 100 100", h);
    ...
    let y = e.el.offsetWidth || e.width || 60, v = e.el.offsetHeight || e.height || 60;
    if (Number.isNaN(y) || Number.isNaN(v))
      return h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L 100 100", h);
    o.isReverse && ([r, c, u, f, _, p, y, v] = [
      u,
      f,
      r,
      c,
    ...
    const b = [
      ...
      s,
      n
    ], L = this.options.defaultJunctionPoint || W.border, G = o.fromJunctionPoint || i.junctionPoint || L, E = o.toJunctionPoint || e.junctionPoint || L, N = this._getJunctionPoint(G, b), X = this._getJunctionPoint(E, S);
    if (!N || !X)
      return this.createReturnValue(
        "Unable to calculate the starting point and ending point of the line.",
        h
      );
    const w = N.x, C = N.y, Y = X.x, O = X.y;
    if (i === e) {
      const F = r + _ / 2, T = c + p / 2, H = Math.atan2(C - T, w - F), z = Math.sin(H + Math.PI) * 5, k = Math.cos(H + Math.PI) * 5, I = { x: w - z, y: C - k }, V = { x: w + z, y: C + k }, Z = w - k * 5, J = C - z * 5, j = w - k * 5, U = C - z * 5, lt = `M${I.x},${I.y} C${Z},${J} ${j},${U} ${V.x},${V.y}`;
      return h.x = w - k / (k + z) * 20, h.y = C + z / (k + z) * 20, h.rotate = 0, this.createReturnValue(lt, h);
    }
    ...
    if (Number.isNaN(Y) || Number.isNaN(O))
      return console.error("error end point:", e), h.x = 50, h.y = 50, h.rotate = 0, this.createReturnValue("M 0 0 L 100 100", h);
    let M = Y - w, P = O - C, ie = M > 0 ? 1 : -1, se = P > 0 ? 1 : -1, D = l === "v" ? se : ie, nt = "";
    if (a === 4) {
      const F = Math.floor(60 / (s + 1) * (n + 1)) - 30;
      if (l === "v")
        P = P - (D * 33 + F), h.x = w + M + 5, h.y = C + D * 40 + F, h.rotate = 90, nt = `M ${w} ${C} v${D * 33 + F} h${M + F} v${P}`;
      else {
        h.x = w + D * 50 - (D < 0 ? 30 : 0), h.y = C + P - 5 + F, M = M - (D * 33 + F), P = P + D * F;
        let T = this.options.defaultPloyLineRadius || 0;
        const H = D * 33 + F - T;
        if (T > 0) {
          Math.abs(C - O) < T * 2 && (T = Math.abs(C - O) / 2);
          const z = T * (w < Y ? 1 : -1), k = T * (C < O ? 1 : -1), I = [];
          I.push(`M ${w - z} ${C}`), I.push(`h${H}`), I.push(`C${w + H + z},${C}, ${w + H + z},${C + k}, ${w + H + z},${C + k}`), I.push(`v${P - k - k}`);
          const V = w + H + z, Z = C + k + (P - k - k);
          I.push(`C${V},${Z + k}, ${V + z},${Z + k}, ${V + z},${Z + k}`), I.push(`h${M - T}`), nt = I.join(" ");
        } else
          nt = `M ${w} ${C} h${H} v${P - T} h${M - T}`;
      }
    } else if (a === 2 || a === 3 || a === 5 || a === 6) {
      const F = r + _ / 2, T = c + p / 2, H = u + y / 2, z = f + v / 2, k = w - F, I = C - T, V = Y - H, Z = O - z, J = 1 / (s + 1) * (n + 1);
      let j, U;
      if (a === 2)
        j = l === "v" ? { x: 0, y: D * 30 } : { x: D * 30, y: 0 }, U = l === "v" ? { x: M * J, y: D * -10 } : { x: D * -10, y: P * J };
      else if (a === 3)
        j = l === "v" ? { x: 0, y: P * J } : { x: D * 30, y: 0 }, U = l === "v" ? { x: 0, y: 0 } : { x: D * -10, y: P * J };
      else if (a === 5)
        j = l === "v" ? { x: 0, y: 0 } : { x: 0, y: 0 }, U = l === "v" ? { x: 0, y: P * J } : { x: M * J, y: 0 };
      else if (a === 6) {
        const ct = Math.abs(Y - w) / 2 * 0.6;
        G === W.left ? j = { x: k + ct - 100, y: I } : j = { x: k + ct, y: I }, V > 0 ? U = { x: V - ct + M + 100, y: Z + P } : U = { x: V - ct + M, y: Z + P };
      }
      const lt = this.calcCurveCenter(
        { x: w, y: C },
        j,
        U,
        { x: M, y: P }
      );
      h.x = lt.x, h.y = lt.y, nt = `M${w},${C} c${j.x},${j.y} ${U.x},${U.y} ${M},${P}`;
    } else
      h.rotate = B.getTextAngle(w, C, Y, O), h.x = Math.round(N.x + M / 2), h.y = Math.round(N.y + P / 2), Number.isNaN(h.rotate) && (h.rotate = 0), nt = `M ${w} ${C} L ${Y} ${O}`;
    return this.createReturnValue(nt, h);
  }
  calcCurveCenter(i, e, o, n) {
    const a = i.x + 0.7 * e.x + 0.48999999999999994 * o.x + 0.3429999999999999 * n.x, l = i.y + 0.7 * e.y + 0.7 ** 2 * o.y + 0.7 ** 3 * n.y;
    return { x: a, y: l };
  }
  ...
  createCheckedLineStrokeWidth() {
    ...
    try {
      ...
      if (!e)
        return this.options.defaultLineWidth + 8;
      const o = e.relations.findIndex((s) => s.id === i);
      if (o === -1)
        return this.options.defaultLineWidth + 8;
      const n = e.relations[o];
      return n.lineWidth ? n.lineWidth + 8 : this.options.defaultLineWidth + 8;
    } catch (e) {
      d(e);
    }
  }
  getTextTransform(i, e, o, n) {
    if (Number.isNaN(e) || Number.isNaN(o))
      return "translate(0,0)";
    const s = i.lineShape === void 0 ? this.options.defaultLineShape : i.lineShape;
    return s === 1 || s === 4 ? `translate(${e},${o})rotate(${n || 0})` : `translate(${e},${o})`;
  }
  getArrow(i, e, o = !1) {
...
class Oe extends Ne {
  constructor(e, o) {
    super(e, o);
    g(this, "zoomCenter_of_newSize", { x: 0, y: 0 });
  }
  zoom(e, o) {
    this.options.canvasZoom + e < 10 && (d("zoom:reset zoom=10"), e = 10 - this.options.canvasZoom);
    const n = this.options.canvasZoom + e, s = this.showZoomCenter(o, e);
    this.options.canvasOffset.x += s.buff_x, this.options.canvasOffset.y += s.buff_y, this.options.canvasZoom = n, this.refreshNVAnalysisInfo();
  }
  setZoom(e, o) {
  ...
  getCanvasCoordinateByClientCoordinate(e) {
    const o = this.options.canvasZoom / 100, { NMCanvasStart: n, NMZoomCenter: s } = this.analysisByZoom(o, e), a = {
      x: s.x - n.x,
      y: s.y - n.y
    };
    return {
  ...
  analysisByZoom(e, o) {
    ...
    const a = this.options.canvasSize.width * e, l = this.options.canvasSize.height * e;
  ...
  showZoomCenter(e, o) {
    ...
    const n = this.options.canvasZoom / 100, s = this.analysisByZoom(n, e), a = (this.options.canvasZoom + o) / 100, l = this.analysisByZoom(a, e), r = a / n, c = 0, u = 0, f = a / n, h = 0, _ = 0;
    this.zoomCenter_of_newSize.x = r * s.NMViewBuff.x + u * s.NMViewBuff.y + h, this.zoomCenter_of_newSize.y = c * s.NMViewBuff.x + f * s.NMViewBuff.y + _;
    ...
    let v = s.NMCanvasStart.x - s.NMCanvasCenter.x, b = s.NMCanvasStart.y - s.NMCanvasCenter.y, S = r * v + u * b + h, L = c * v + f * b + _;
    return l.NMCanvasStart.x = p + s.NMCanvasCenter.x + S, l.NMCanvasStart.y = p + s.NMCanvasCenter.y + L, v = s.NMCanvasEnd.x - s.NMCanvasCenter.x, b = s.NMCanvasEnd.y - s.NMCanvasCenter.y, S = r * v + u * b + h, L = c * v + f * b + _, l.NMCanvasEnd.x = p + s.NMCanvasCenter.x + S, l.NMCanvasEnd.y = p + s.NMCanvasCenter.y + L, s.NMCanvasOffsetBuff.x = p, s.NMCanvasOffsetBuff.y = y, {
      buff_x: p,
      buff_y: y
    };
  }
...
class ze extends Oe {
  ...
  doLayout() {
    return x(this, null, function* () {
      ...
      this.options.showMaskWhenLayouting && this.loading(), yield ue(200), this.options.showMaskWhenLayouting && this.clearLoading(), d("node size\uFF1A", this.graphData.nodes.length);
  ...
  moveToCenter() {
    return x(this, null, function* () {
      if (this.options.useAnimationWhenRefresh) {
        ...
        d("centerOffset:", e.offset_x, e.offset_y);
        const o = this.options.viewSize.width / 2 - i.x + e.offset_x, n = this.options.viewSize.height / 2 - i.y + e.offset_y;
  ...
  placeOtherNodes() {
    return x(this, null, function* () {
      ...
      this.graphData.nodes.forEach((n) => {
        i.includes(n) || (this.options.placeSingleNode && (!n.targetNodes || n.targetNodes.length === 0) && n.fixed !== !0 ? (n.x = Math.floor(Math.random() * 200) - 100, n.y = Math.floor(Math.random() * 200) - 100, n.lot || (n.lot = { childs: [] }), n.lot.placed = !0, n.singleNode = !0, o.push(n)) : e.push(n));
      }), this.options.placeSingleNode && this.options.layoutName !== "fixed" && this.placeSingleNodes(o), this.options.placeOtherGroup && this.options.layoutName !== "fixed" && (yield this.placeOtherGroup(e, i), this._dataUpdated());
    });
  }
  placeSingleNodes(i) {
    if (i.length > 0) {
      d("sigle nodes:", i.length);
      const e = new it({ layoutName: "force" }, this.options);
  ...
  placeOtherGroup(i, e) {
    return x(this, null, function* () {
      if (i.length > 0) {
        ...
        const o = JSON.parse(JSON.stringify(this.layouter.layoutOptions)), n = ht(o, this.options);
        n.isMainLayouer = !1;
        const s = i[0], a = this.getStuffSize(e);
        d("[placeOtherGroup]placeOtherGroup:", n.layoutOptions.layoutName, "root:", s.text);
        let l = n.layoutOptions.layoutName.includes("tree") ? 300 : 600;
        if (n.layoutOptions.layoutName === "force") {
          const u = n;
          u.force_node_repulsion = 0.2, u.force_line_elastic = 1.5, l = 100;
        }
        s.x = a.maxX + l, s.y = 0, n.layoutOptions.fixedRootNode = !0;
        const r = [];
        this.findGroupNodes(s, r), d("[placeOtherGroup]thisGroupNodes:", i.length), this.layouter.requireLinks && this.layouter.setLinks(this.getLinks()), yield n.placeNodes(r, s), e.push(...r);
        const c = [];
        i.forEach((u) => {
          e.includes(u) || c.push(u);
        }), yield this.placeOtherGroup(c, e), this._dataUpdated();
      }
    });
  }
  zoomToFit(i) {
    return x(this, null, function* () {
      const e = this.getStuffSize(), o = this.options.viewSize.width / e.width, n = this.options.viewSize.height / e.height, s = Math.min(o, n, 1);
      d("zoomToFit:", { stuffSize: e, zoomPercent: s, zoomPercentX: o, zoomPercentY: n, viewSize: this.options.viewSize }), this.options.useAnimationWhenRefresh ? (yield this.animateToZoom(s * 100, 300), this._dataUpdated(), i && i()) : (this.setZoom(s * 100), this._dataUpdated(), i && i());
    });
  }
  animateGoto(i, e, o) {
    return x(this, null, function* () {
      return new Promise((n, s) => {
        d("animateGoto:", i, e);
        const a = i - this.options.canvasOffset.x, l = e - this.options.canvasOffset.y, r = o, c = 5, u = Math.round(a / c), f = Math.round(l / c), h = r / c;
        this.animateStepAction(0, h, c, () => {
          this.options.canvasOffset.x += u, this.options.canvasOffset.y += f, this._dataUpdated();
        }, () => {
          n();
        });
      });
  ...
  animateToZoom(i, e) {
    return x(this, null, function* () {
      return new Promise((o, n) => {
        const s = i - this.options.canvasZoom, a = e, l = 5, r = Math.round(s / l), c = a / l;
  ...
  animateStepAction(i, e, o, n, s) {
    i < o ? (n(i, o), setTimeout(() => {
      this.animateStepAction(i + 1, e, o, n, s);
    }, e)) : s();
  }
  toggleAutoLayout() {
  ...
  startAutoLayout() {
    this.options.autoLayouting = !0, this.layouter.autoLayout ? this.layouter.autoLayout(!0, this.isReact && (() => {
      this._dataUpdated();
    })) : d("Current layout not support stop()");
  }
  stopAutoLayout() {
...
const Pt = (t) => {
  ...
  if (q(t)) {
    ...
    i.clientX = t.clientX, i.clientY = t.clientY;
  return i;
}, R = {
  startDrag(t, i, e, o) {
    o ? mt = (n, s, a) => {
      ...
      K.x = tt.x + (n - et.x), K.y = tt.y + (s - et.y);
    }, gt = e, K = i, tt.x = K.x, tt.y = K.y, d("[canvas]onDragStart...", q(t), t);
    try {
      const n = Pt(t);
      et.x = n.clientX, et.y = n.clientY, q(t) ? (document.body.addEventListener("touchmove", R.onNodeMove), document.body.addEventListener("touchend", R.onNodeDragend), t.preventDefault()) : (document.body.addEventListener("mousemove", R.onNodeMove), document.body.addEventListener("mouseup", R.onNodeDragend));
    } catch (n) {
  ...
  onNodeMove(t) {
    const i = Pt(t);
    mt(i.clientX, i.clientY, t);
  },
  onNodeDragend(t) {
    q(t) ? (document.body.removeEventListener("touchmove", R.onNodeMove), document.body.removeEventListener("touchend", R.onNodeDragend)) : (document.body.removeEventListener("mousemove", R.onNodeMove), document.body.removeEventListener("mouseup", R.onNodeDragend)), d("[canvas]onDragend...", q(t), t), gt && gt(
      K.x - tt.x,
      K.y - tt.y,
      t
    );
...
class Be extends ze {
  constructor(e, o) {
    super(e, o);
    g(this, "prevClickTime", 0);
    g(this, "movingListener");
    g(this, "step1EventTime", 0);
    g(this, "onCreateLineCallback");
  }
  ...
  setCheckedLinkAndLine(e, o) {
    this.options.checkedLinkId = e.seeks_id, this.options.checkedLineId = o ? o.id : "";
  }
  clearChecked() {
  ...
  onNodeClick(e, o) {
    ...
    d("[node]node click", e.text), this.prevClickTime = Date.now(), !o.shiftKey && this.options.disableNodeClickEffect !== !0 && e.disableDefaultClickEffect !== !0 && (this.options.checkedLinkId = "", this.options.checkedLineId = "", this.setCheckedNode(e.id)), this.options.creatingLinePlot && this.onNodeClickWhenCreatingLinePlot(e), this.listeners.onNodeClick && this.listeners.onNodeClick(e, o);
  }
  onLineClick(e, o, n) {
    d("onLineClick:", "line:", e, "link:", o), this.options.disableLineClickEffect !== !0 && e.disableDefaultClickEffect !== !0 && (this.setCheckedNode(""), this.setCheckedLinkAndLine(o, e)), this.listeners.onLineClick && this.listeners.onLineClick(e, o, n);
  }
  expandOrCollapseNode(e, o) {
    return x(this, null, function* () {
      e.expanded === !1 ? yield this.expandNode(e, o) : yield this.collapseNode(e, o);
    });
  }
  setChildsFromPosition(e, o) {
    e.lot.childs.forEach((n) => {
      n.x = o.x, n.y = o.y, this.setChildsFromPosition(n, o);
    });
  }
  expandNode(e, o) {
    return x(this, null, function* () {
      d("onNodeExpand:", e), e.expanded = !0, this.options.useAnimationWhenExpanded && (yield this.layouter.snapshotBeforeAnimation(), this.setChildsFromPosition(e, e), yield this.layouter.animationLayout(!1)), d("relayout check:", this.options.reLayoutWhenExpandedOrCollapsed), this.options.reLayoutWhenExpandedOrCollapsed && (d("relayout..."), yield this.layouter.snapshotBeforeAnimation(), yield this.doLayout()), this.updateElementLines(), this._dataUpdated(), this.listeners.onNodeExpand && this.listeners.onNodeExpand(e, o);
    });
  }
  setChildsToPosition(e, o) {
    e.lot.childs.forEach((n) => {
  ...
  collapseNode(e, o) {
    return x(this, null, function* () {
      d("onNodeCollapse:", e), this.options.useAnimationWhenExpanded && (yield this.layouter.snapshotBeforeAnimation(), this.setChildsToPosition(e, e), yield this.layouter.animationLayout(!1)), e.expanded = !1, d("relayout check:", this.options.reLayoutWhenExpandedOrCollapsed), this.options.reLayoutWhenExpandedOrCollapsed && (d("relayout..."), yield this.layouter.snapshotBeforeAnimation(), yield this.doLayout()), this.updateElementLines(), this._dataUpdated(), this.listeners.onNodeCollapse && this.listeners.onNodeCollapse(e, o);
    });
  }
  onNodeDragEnd(e, o) {
    this.updateElementLines(), this.listeners.onNodeDragEnd && this.listeners.onNodeDragEnd(e, o);
  }
  onCanvasDragEnd(e) {
  ...
  onCanvasSelectionEnd(e, o) {
    this.listeners.onCanvasSelectionEnd && this.listeners.onCanvasSelectionEnd(e, o);
  }
  startCreatingNodePlot(e, o) {
    this.options.newNodeTemplate = at(JSON.parse(JSON.stringify(wt))), this.options.creatingNodePlot = !0;
    const n = q(e);
    this.options.showTemplateNode = !n, console.log("is touch event:", n);
    let s = (p, y) => {
    ...
    const r = _t(e), c = r.clientX - l.x + 10, u = r.clientY - l.y + 10;
    n || s(c, u);
    const f = (p) => {
      const y = this.$dom.getBoundingClientRect();
      d("[CreatingNodePlot]objectTemplateMove");
      const v = p.clientX - y.x + 10, b = p.clientY - y.y + 10;
      s(v, b);
    }, h = (p) => {
      d("[CreatingNodePlot]user abort!"), this.$dom.removeEventListener("mousemove", f), this.$dom.removeEventListener("click", _), this.$dom.removeEventListener("contextmenu", h), this.options.creatingNodePlot = !1;
    }, _ = (p) => {
      let y = !1;
      if (this.options.creatingNodePlot || (y = !0), this.$dom.removeEventListener("mousemove", f), this.$dom.removeEventListener("click", _), this.$dom.removeEventListener("contextmenu", h), this.options.creatingNodePlot = !1, y) {
        d("[CreatingNodePlot]action be abort!");
        return;
      }
      const v = _t(p), b = v.clientX - l.x + 10, S = v.clientY - l.y + 10;
      if (o && o.disableClickCreate && Math.abs(c - b) < 5 && Math.abs(u - S) < 5) {
        d("[CreatingNodePlot]create node be abort!");
        return;
      }
      const L = this.getCanvasCoordinateByClientCoordinate({ x: v.clientX, y: v.clientY });
      d("[CreatingNodePlot]objectBePlaced:", L), a(L.x, L.y), this._dataUpdated();
    };
    setTimeout(() => {
      this.$dom.addEventListener("click", _), this.$dom.addEventListener("contextmenu", h);
    }, 300), n || this.$dom.addEventListener("mousemove", f);
  }
  startCreatingLinePlot(e, o) {
    const n = q(e);
    o && o.onCreateLine && (this.onCreateLineCallback = o.onCreateLine), o && o.template && Object.assign(this.options.newLineTemplate, o.template), this.options.newLinkTemplate.fromNode = null, o && o.fromNode && (this.options.newLinkTemplate.toNode.x = o.fromNode.x + 50, this.options.newLinkTemplate.toNode.y = o.fromNode.y + 50, this.options.newLinkTemplate.fromNode = o.fromNode, this.step1EventTime = Date.now()), this.options.creatingLinePlot = !0, this.options.newLinkTemplate.toNodeObject = null, d("[CreatingLinePlot]startCreatingLinePlot:", n), n || (d("[CreatingLinePlot]Listener move"), this.movingListener = this.onMovingWhenCreatingLinePlot.bind(this), this.$dom.addEventListener("mousemove", this.movingListener));
  }
  ...
  onCanvasClickWhenCreatingLinePlot(e) {
    ...
    if (!this.options.newLinkTemplate.toNodeObject) {
      ...
      const o = _t(e), n = this.getCanvasCoordinateByClientCoordinate({ x: o.clientX, y: o.clientY });
  ...
  onCreateLine(e, o) {
    d("[CreatingLinePlot][fire-event]onCreateLine:", e, o), this.onCreateLineCallback && this.onCreateLineCallback(e, o, this.options.newLineTemplate);
  }
  isNode(e) {
    const o = yt(e, "rel-node-peel", "rel-map");
    return o ? this.getNodeById(o.dataset.id) : void 0;
  }
  isLink(e) {
    const o = yt(e, "rel-link-peel", "rel-map");
    return o ? this.getLinkById(o.dataset.id) : void 0;
  }
  onContextmenu(e) {
    let o = "canvas", n = this.isNode(e.target);
    n ? o = "node" : (n = this.isLink(e.target), n && (o = "link")), d("contextmenu:objectType", o, n), this.listeners.onContextmenu && this.listeners.onContextmenu(e, o, n);
  }
  fullscreen(e) {
    e === void 0 ? (this.options.fullscreen = !this.options.fullscreen, ot.toggle(this.$dom).then(() => {
      setTimeout(() => {
  ...
  handleSelect(e) {
    return x(this, null, function* () {
      d("checked:", e), scrollTo({
        top: this.$dom.offsetTop
      }), yield this.animateToZoom(100, 300);
      const o = e.width || 50, n = e.height || 50, s = e.x * -1 + this.options.viewSize.width / 2 - o / 2, a = e.y * -1 + this.options.viewSize.height / 2 - n / 2;
      yield this.animateGoto(s, a, 500), this.options.checkedNodeId = e.id, this.refreshNVAnalysisInfo();
    });
  }
  onMouseWheel(e) {
    ...
    let n = e.deltaY;
    n === void 0 && (n = e.wheelDelta);
    const s = -1;
    n > 0 ? this.zoom(5 * s, o) : this.zoom(-5 * s, o);
  }
  onLineDragStart(e, o) {
    d("onLineDragStart...");
    const n = { x: e.fromNode.x, y: e.fromNode.y }, s = { x: e.toNode.x, y: e.toNode.y }, a = (l, r, c, u, f) => {
      e.fromNode.x = n.x + l / (this.options.canvasZoom / 100), e.fromNode.y = n.y + r / (this.options.canvasZoom / 100), e.toNode.x = s.x + l / (this.options.canvasZoom / 100), e.toNode.y = s.y + r / (this.options.canvasZoom / 100), this._dataUpdated();
    };
    R.startDrag(o, { x: 0, y: 0 }, (...l) => {
  ...
  onCanvasDragStart(e) {
    if (d("[canvas]onCanvasDragStart..."), this.options.disableDragCanvas || e.shiftKey) {
      this.startCreateSelection(e);
      return;
    }
    if (!this.options.disableDragLine) {
      const n = this.isLink(e.target);
      if (n) {
        this.onLineDragStart(n, e);
        return;
      }
    }
    let o;
    if (q(e)) {
      let n, s = 1;
      o = (a, l, r, c, u) => {
        const f = u.touches || u.targetTouches, h = f[0];
        if (f && f.length > 1) {
          u.preventDefault();
          const _ = f[1];
          n || (n = { x: _.clientX, y: _.clientY }, s = this.options.canvasZoom);
          const p = { x: h.clientX, y: h.clientY }, y = { x: _.clientX, y: _.clientY }, v = Math.hypot(n.x - c.x, n.y - c.y), S = Math.hypot(y.x - p.x, y.y - p.y) / v, L = s * S;
          this.setZoom(L), this._dataUpdated();
        } else {
          const _ = h.clientX, p = h.clientY;
          let y = r.x + (_ - c.x), v = r.y + (p - c.y);
          this.options.useHorizontalView ? (y = r.x + (p - c.y), v = r.y - (_ - c.x), this.setCanvasOffset(y, v)) : this.setCanvasOffset(y, v), this._dataUpdated();
        }
      };
    } else
      o = (n, s, a, l, r) => {
        const c = a.x + n, u = a.y + s;
        this.setCanvasOffset(c, u), this._dataUpdated();
      };
    R.startDrag(e, this.options.canvasOffset, (...n) => {
      this.onCanvasDragStop(...n);
    }, o);
  }
  onCanvasDragStop(e, o, n) {
    if (d("[canvas]onCanvasDragStop..."), this.options.creatingSelection) {
      console.log("creatingSelection end"), this.options.creatingSelection = !1, this._dataUpdated(), this.onCanvasSelectionEnd(this.options.selectionView, n);
      return;
    }
    if (e === 0 && o === 0) {
    ...
    Math.abs(e) + Math.abs(o) > 6 ? setTimeout(() => {
      d("[canvas]onDragEnd1"), this._dataUpdated(), this.onCanvasDragEnd(n);
    }, 100) : (d("[canvas]onDragEnd2"), this._dataUpdated(), this.onCanvasDragEnd(n));
  }
  startCreateSelection(e) {
    ...
    const n = (s, a, l, r, c) => {
      if (!o && Math.abs(s) + Math.abs(a) > 6 && (o = !0, this.options.creatingSelection = !0, this.options.selectionView.x = r.x, this.options.selectionView.y = r.y), o) {
        ...
        s < 0 ? (this.options.selectionView.x = r.x + s - u.x, this.options.selectionView.width = Math.abs(s)) : (this.options.selectionView.x = r.x - u.x, this.options.selectionView.width = s), a < 0 ? (this.options.selectionView.y = r.y + a - u.y, this.options.selectionView.height = Math.abs(a)) : (this.options.selectionView.y = r.y - u.y, this.options.selectionView.height = a);
      }
      this._dataUpdated();
    };
    R.startDrag(e, { x: 0, y: 0 }, (...s) => {
  ...
  onNodeDragStart(e, o) {
    ...
    const n = (s, a, l) => {
      this.onNodeDraged(e, s, a, l), this._dataUpdated();
    };
    R.startDrag(o, e, n, (s, a, l) => {
      let r = s / (this.options.canvasZoom / 100) + l.x, c = a / (this.options.canvasZoom / 100) + l.y;
      this.setNodePosition(e, r, c), this.options.useHorizontalView ? (r = a / (this.options.canvasZoom / 100) + l.x, c = -s / (this.options.canvasZoom / 100) + l.y, this.setNodePosition(e, r, c)) : this.setNodePosition(e, r, c), this.updateElementLines(), this._dataUpdated();
    });
  }
  onNodeDraged(e, o, n, s) {
    if (o === 0 && n === 0) {
      d("[node]node click by drag"), this.onNodeClick(e, s);
      return;
    }
    this.options.isMoveByParentNode && e.lot.childs.forEach((a) => {
      a.x += o, a.y += n;
    }), Math.abs(o) + Math.abs(n) > 6 ? (this.prevClickTime = Date.now(), setTimeout(() => {
      d("[node]onDragEnd2"), this.onNodeDragEnd(e, s);
    }, 100)) : (d("[node]onDragEnd1"), this.onNodeDragEnd(e, s));
  }
}
class $e extends Be {
  constructor(i, e) {
  ...
  switchLayout(i, e = !0, o = !1) {
    return x(this, null, function* () {
      ...
      d("[change layout]switchLayout"), this.stopAutoLayout(), ut(i, this.options), this._initLayoutByLayoutOptions(i), this.layouter.allNodes = n, this.layouter.rootNode = s, e ? yield this.refresh() : (o || (this.disableNextLayoutAnimation = !0), yield this.doLayout());
    });
  }
  setJsonData(i, e = !1) {
    return x(this, null, function* () {
      yield this._setJsonData(i);
      const o = i.rootId;
      ...
      e && (d("resetViewSize:", e), this.resetViewSize()), this.disableNextLayoutAnimation = !0, yield this.doLayout();
    });
  }
  appendJsonData(i, e = !0) {
    return x(this, null, function* () {
      d("appendData:", i), this.loadGraphJsonData(i), e && (this.disableNextLayoutAnimation = !0, yield this.doLayout());
    });
  }
}
class Qt extends $e {
...
var De = function() {
  ...
  return e("div", { staticClass: "c-btn-open-close", class: ["c-expand-positon-" + t.expandHolderPosition] }, [e("span", { class: t.expandButtonClass, style: { "background-color": t.color }, on: { click: function(o) {
    return o.stopPropagation(), t.expandOrCollapseNode.apply(null, arguments);
  }, touchend: function(o) {
    return o.stopPropagation(), t.expandOrCollapseNode.apply(null, arguments);
  } } })]);
}, Te = [];
function A(t, i, e, o, n, s, a, l) {
  var r = typeof t == "function" ? t.options : t;
  i && (r.render = i, r.staticRenderFns = e, r._compiled = !0), o && (r.functional = !0), s && (r._scopeId = "data-v-" + s);
  var c;
  if (a ? (c = function(h) {
...
const Fe = /* @__PURE__ */ function() {
  ...
  computed: {
    oldVersionSlot() {
      const t = this.$scopedSlots.node({ node: this.nodeProps });
    ...
    borderStyle() {
      const t = this.nodeProps.borderWidth === void 0 ? this.options.defaultNodeBorderWidth : this.nodeProps.borderWidth;
      return (this.nodeProps.borderColor || this.options.defaultNodeBorderColor) + " solid " + t + "px";
    },
    nodeWidth() {
      if (this.nodeProps.width === 0)
        return;
      const t = this.nodeProps.width || this.options.defaultNodeWidth;
      if (!!t)
        return t + "px";
    },
    nodeHeight() {
      if (this.nodeProps.height === 0)
        return;
      const t = this.nodeProps.height || this.options.defaultNodeHeight;
      if (!!t)
        return t + "px";
    }
  },
    ...
    expandOrCollapseNode(t) {
      return x(this, null, function* () {
        d("expandOrCollapseNode", this.expanding), !this.expanding && (this.expanding = !0, setTimeout(() => {
          this.expanding = !1;
        }, 300), yield this.relationGraph.expandOrCollapseNode(this.nodeProps, t));
      });
    },
    onDragStart(t) {
      this.relationGraph.onNodeDragStart(this.nodeProps, t);
    },
    onclick(t) {
      this.relationGraph.onNodeClick(this.nodeProps, t);
    },
    isAllowShowNode(t) {
      return m.isAllowShowNode(t);
    }
  }
};
var We = function() {
  var t = this, i = t.$createElement, e = t._self._c || i;
  return e("div", { directives: [{ name: "show", rawName: "v-show", value: t.isAllowShowNode(t.nodeProps), expression: "isAllowShowNode(nodeProps)" }], ref: "seeksRGNode", staticClass: "rel-node-peel", class: [t.nodeProps.selected && "rel-node-selected", t.nodeProps.id === t.options.checkedNodeId && "rel-node-peel-checked", t.nodeProps.className], style: {
    left: t.nodeProps.x + "px",
    top: t.nodeProps.y + "px",
    opacity: t.nodeProps.opacity > 1 ? t.nodeProps.opacity / 100 : t.nodeProps.opacity
  }, attrs: { "data-id": t.nodeProps.id } }, [t.showExpandHolder ? [t.options.oldVueVersion && !t.options.ovUseNodeExpandHolderSlot ? [e("RGNodeExpandHolder", { attrs: { nodeProps: t.nodeProps, expandButtonClass: t.expandButtonClass, expandOrCollapseNode: t.expandOrCollapseNode, expandHolderPosition: t.nodeProps.expandHolderPosition || t.options.defaultExpandHolderPosition, color: t.options.defaultExpandHolderColor || t.nodeProps.color || t.options.defaultNodeColor } })] : t._t("node-expand-holder", function() {
    return [e("RGNodeExpandHolder", { attrs: { nodeProps: t.nodeProps, expandButtonClass: t.expandButtonClass, expandOrCollapseNode: t.expandOrCollapseNode, expandHolderPosition: t.nodeProps.expandHolderPosition || t.options.defaultExpandHolderPosition, color: t.options.defaultExpandHolderColor || t.nodeProps.color || t.options.defaultNodeColor } })];
  }, { nodeProps: t.nodeProps, expandButtonClass: t.expandButtonClass, expandOrCollapseNode: t.expandOrCollapseNode, expandHolderPosition: t.nodeProps.expandHolderPosition || t.options.defaultExpandHolderPosition, color: t.options.defaultExpandHolderColor || t.nodeProps.color || t.options.defaultNodeColor })] : t._e(), t.nodeProps.html ? e("div", { domProps: { innerHTML: t._s(t.nodeProps.html) }, on: { click: function(o) {
    return t.onclick(o);
  }, mousedown: function(o) {
    return !o.type.indexOf("key") && t._k(o.keyCode, "left", 37, o.key, ["Left", "ArrowLeft"]) || "button" in o && o.button !== 0 ? null : (o.stopPropagation(), t.onDragStart(o));
  }, touchstart: function(o) {
    return o.stopPropagation(), t.onDragStart(o);
  } } }) : e("div", { staticClass: "rel-node", class: ["rel-node-shape-" + (t.nodeProps.nodeShape === void 0 ? t.options.defaultNodeShape : t.nodeProps.nodeShape), "rel-node-type-" + t.nodeProps.type, t.nodeProps.id === t.options.checkedNodeId ? "rel-node-checked" : "", t.nodeProps.flashing ? "rel-node-flashing" : "", t.nodeProps.styleClass, t.nodeProps.innerHTML ? "rel-diy-node" : ""], style: { "background-color": t.nodeProps.color === void 0 ? t.options.defaultNodeColor : t.nodeProps.color, color: t.nodeProps.fontColor === void 0 ? t.options.defaultNodeFontColor : t.nodeProps.fontColor, border: t.borderStyle, width: t.nodeWidth, height: t.nodeHeight }, on: { click: function(o) {
    return t.onclick(o);
  }, mousedown: function(o) {
    return !o.type.indexOf("key") && t._k(o.keyCode, "left", 37, o.key, ["Left", "ArrowLeft"]) || "button" in o && o.button !== 0 ? null : (o.stopPropagation(), t.onDragStart(o));
  }, touchstart: function(o) {
    return o.stopPropagation(), t.onDragStart(o);
  } } }, [t.options.hideNodeContentByZoom === !0 && t.options.canvasZoom < 40 ? t._e() : [t.options.oldVueVersion && !t.options.ovUseNodeSlot ? [t.nodeProps.innerHTML ? e("div", { domProps: { innerHTML: t._s(t.nodeProps.innerHTML) } }) : e("div", { staticClass: "c-node-text", style: { color: t.nodeProps.fontColor || t.options.defaultNodeFontColor } }, [e("span", { domProps: { innerHTML: t._s(t.nodeProps.text) } })])] : t._t("node", function() {
    return [t.nodeProps.innerHTML ? e("div", { domProps: { innerHTML: t._s(t.nodeProps.innerHTML) } }) : e("div", { staticClass: "c-node-text", style: { color: t.nodeProps.fontColor || t.options.defaultNodeFontColor } }, [e("span", { domProps: { innerHTML: t._s(t.nodeProps.text) } })])];
  }, { node: t.nodeProps })]], 2)], 2);
}, Ve = [];
const Nt = {};
var je = /* @__PURE__ */ A(
  He,
...
const Lt = /* @__PURE__ */ function() {
  ...
  computed: {
    ...
    pathData() {
      try {
        const { path: t, textPosition: i } = this.relationGraph.createLinePath(
          this.link,
          this.relation,
          this.relationIndex
        );
        let e = {};
        try {
          e = this.relationGraph.getTextTransform(
            this.relation,
            i.x,
            i.y,
            i.rotate
  ...
  methods: {
    onClick(t, i) {
      this.relationGraph.onLineClick(t, this.link, i);
    }
  }
};
var Ye = function() {
  var t = this, i = t.$createElement, e = t._self._c || i;
  return e("g", [e("path", { staticClass: "c-rg-line", class: [
    t.relation.styleClass,
    t.relation.dashType ? "rg-line-dashtype-" + t.relation.dashType : void 0,
    t.relation.animation ? "rg-line-anm-" + t.relation.animation : void 0,
    t.checked ? "c-rg-line-checked" : void 0
  ], style: {
    opacity: t.relation.opacity,
    "stroke-width": (t.relation.lineWidth ? t.relation.lineWidth : t.options.defaultLineWidth) + "px"
  }, attrs: { d: t.pathData.path, stroke: t.relation.color ? t.relation.color : t.options.defaultLineColor, "marker-start": t.showStartArrow, "marker-end": t.showEndArrow, fill: "none" }, on: { touchstart: function(o) {
    return t.onClick(t.relation, o);
  }, click: function(o) {
    return t.onClick(t.relation, o);
  } } }), t.options.defaultShowLineLabel && t.options.canvasZoom > 40 ? e("g", { attrs: { transform: t.pathData.textTransform } }, [e("text", { key: "t-" + t.relation.seeks_id, staticClass: "c-rg-line-text", class: { "c-rg-line-text-checked": t.checked }, style: {
    opacity: t.relation.opacity,
    fill: t.relation.fontColor ? t.relation.fontColor : t.options.defaultLineFontColor ? t.options.defaultLineFontColor : t.relation.color ? t.relation.color : t.options.defaultLineColor
  }, attrs: { x: t.relation.textOffset_x || t.options.defaultLineTextOffset_x || 0, y: t.relation.textOffset_y || t.options.defaultLineTextOffset_y || 10, "text-anchor": "middle" }, on: { touchstart: function(o) {
    return t.onClick(t.relation, o);
  }, click: function(o) {
    return t.onClick(t.relation, o);
...
const Kt = /* @__PURE__ */ function() {
  ...
  computed: {
    textOffset() {
      const t = this.relation.textOffset_x || this.options.defaultLineTextOffset_x || 0, i = this.relation.textOffset_y || this.options.defaultLineTextOffset_y || -8;
    ...
    textAnchor() {
      return this.relation.lineShape === 4 || this.options.defaultLineShape === 4 ? "start" : "middle";
    },
    textHPosition() {
      if (this.relation.lineShape === 4 || this.options.defaultLineShape === 4)
        if (this.options.layoutDirection === "v") {
          const t = this.link.fromNode.x, i = this.link.toNode.x;
          return Math.abs(i - t) + 43;
        } else {
          const t = this.link.fromNode.y, i = this.link.toNode.y;
          return Math.abs(i - t) + 43;
        }
      return "50%";
    },
...
var Ke = function() {
  var t = this, i = t.$createElement, e = t._self._c || i;
  return e("g", [e("use", { staticClass: "c-rg-line", class: [
    t.relation.styleClass,
    t.relation.dashType ? "rg-line-dashtype-" + t.relation.dashType : void 0,
    t.relation.animation ? "rg-line-anm-" + t.relation.animation : void 0,
    t.checked ? "c-rg-line-checked" : void 0
  ], attrs: { "xlink:href": t.pathRef }, on: { touchstart: function(o) {
    return t.onClick(t.relation, o);
  }, click: function(o) {
    return t.onClick(t.relation, o);
  } } }), e("g", { attrs: { transform: t.textOffset } }, [e("text", { staticClass: "c-rg-line-text", class: { "c-rg-line-text-checked": t.checked }, style: {
    opacity: t.relation.opacity,
    fill: t.relation.fontColor ? t.relation.fontColor : t.options.defaultLineFontColor ? t.options.defaultLineFontColor : t.relation.color ? t.relation.color : t.options.defaultLineColor
  }, attrs: { rotate: t.textRotate }, on: { touchstart: function(o) {
    return t.onClick(t.relation, o);
  }, click: function(o) {
    return t.onClick(t.relation, o);
  } } }, [e("textPath", { attrs: { "xlink:href": t.pathRef, startOffset: t.textHPosition, "text-anchor": t.textAnchor, method: "align", spacing: "auto" } }, [t._v(" " + t._s(t.relation.text) + " ")])])])]);
}, to = [];
const zt = {};
var eo = /* @__PURE__ */ A(
  Qe,
...
const no = /* @__PURE__ */ function() {
  ...
  name: "SeeksRGLink",
  components: { RGLineSmart: Kt, RGLineTextByPath: no },
  props: {
    linkProps: {
      mustUseProp: !0,
      default: () => ({}),
...
var so = function() {
  var t = this, i = t.$createElement, e = t._self._c || i;
  return t.linkProps.isHide !== !0 && t.isAllowShowNode(t.linkProps.fromNode) && t.isAllowShowNode(t.linkProps.toNode) ? e("g", { ref: "seeksRGLink", staticClass: "rel-link-peel", class: [t.options.checkedLinkId == t.linkProps.seeks_id ? "c-rg-link-checked" : ""], attrs: { transform: "translate(0,0)", "data-id": t.linkProps.seeks_id } }, [t._l(t.linkProps.relations, function(o, n) {
    return [t.options.oldVueVersion && !t.options.ovUseLineSlot ? [(t.options.lineUseTextPath || o.useTextPath) && o.isHide === !1 ? e("RGLineTextByPath", { key: "l-" + o.id, attrs: { link: t.linkProps, relation: o, "relation-index": n } }) : o.isHide === !1 ? e("RGLineSmart", { key: "l-" + o.id, attrs: { link: t.linkProps, relation: o, "relation-index": n } }) : t._e()] : t._t("line", function() {
      return [(t.options.lineUseTextPath || o.useTextPath) && o.isHide === !1 ? e("RGLineTextByPath", { key: "l-" + o.id, attrs: { link: t.linkProps, relation: o, "relation-index": n } }) : o.isHide === !1 ? e("RGLineSmart", { key: "l-" + o.id, attrs: { link: t.linkProps, relation: o, "relation-index": n } }) : t._e()];
...
var ho = function() {
  var t = this, i = t.$createElement, e = t._self._c || i;
  return e("path", { class: ["c-rg-line-path", t.relation.styleClass, t.checked ? "c-rg-line-checked" : ""], style: { opacity: t.relation.opacity, "stroke-width": (t.relation.lineWidth ? t.relation.lineWidth : t.options.defaultLineWidth) + "px" }, attrs: { id: t.options.instanceId + "-" + t.link.seeks_id + "-" + t.relationIndex, d: t.pathData, stroke: t.relation.color ? t.relation.color : t.options.defaultLineColor, "marker-start": t.relation.showStartArrow && t.relationGraph.getArrow(t.relation, t.link, !0), "marker-end": t.relation.showEndArrow && t.relationGraph.getArrow(t.relation, t.link, !1), fill: "none" } });
}, uo = [];
const Bt = {};
var fo = /* @__PURE__ */ A(
  co,
...
var mo = function() {
  var t = this, i = t.$createElement, e = t._self._c || i;
  return e("g", [t.pathData ? e("path", { staticClass: "c-rg-line-checked-bg", attrs: { d: t.pathData, fill: "none", stroke: "red", "stroke-width": t.strokeWidth } }) : t._e()]);
}, go = [];
const $t = {};
var yo = /* @__PURE__ */ A(
  _o,
...
const xo = /* @__PURE__ */ function() {
  ...
  components: { RGLineChecked: xo, SeeksRGNode: Lt, SeeksRGLink: te, SeeksRGLinePath: ee, RGLineSmart: Kt },
  data() {
    return {};
  },
...
var Co = function() {
  ...
  return e("div", { staticClass: "rel-single-graph", staticStyle: { overflow: "visible" } }, [e("div", { ref: "rgCanvas", staticClass: "rel-linediv" }, [e("svg", { staticClass: "rel-lines-svg", style: { width: t.options.canvasSize.width + "px", height: t.options.canvasSize.height + "px" }, attrs: { xmlns: "http://www.w3.org/2000/svg" } }, [e("defs", [e("linearGradient", { attrs: { id: "my-lineStyle", gradientUnits: "objectBoundingBox", cx: "0.5", cy: "0.5" } }, [e("stop", { attrs: { offset: "0%", "stop-color": "#e52c5c", "stop-opacity": "1" } }), e("stop", { attrs: { offset: "100%", "stop-color": "#FD8B37", "stop-opacity": "0" } })], 1), e("marker", { attrs: { id: t.options.instanceId + "-arrow-default", markerWidth: t.options.defaultLineMarker.markerWidth, markerHeight: t.options.defaultLineMarker.markerHeight, refX: t.options.defaultLineMarker.refX, refY: t.options.defaultLineMarker.refY, "marker-units": "strokeWidth", orient: "auto", viewBox: "0 0 12 12" } }, [e("path", { style: { fill: t.options.defaultLineColor }, attrs: { d: t.options.defaultLineMarker.data } })]), e("marker", { attrs: { id: t.options.instanceId + "-start-arrow-default", markerWidth: t.options.defaultLineMarker.markerWidth, markerHeight: t.options.defaultLineMarker.markerHeight, refX: t.options.defaultLineMarker.refX, refY: t.options.defaultLineMarker.refY, "marker-units": "strokeWidth", orient: "auto", viewBox: "0 0 12 12" } }, [e("path", { style: { fill: t.options.defaultLineColor }, attrs: { d: t.options.defaultLineMarker.data, transform: "translate(12,12)rotate(180)" } })]), e("marker", { attrs: { id: t.options.instanceId + "-arrow-checked", markerWidth: t.options.defaultLineMarker.markerWidth, markerHeight: t.options.defaultLineMarker.markerHeight, refX: t.options.defaultLineMarker.refX, refY: t.options.defaultLineMarker.refY, "marker-units": "strokeWidth", orient: "auto", viewBox: "0 0 12 12" } }, [e("path", { style: { fill: t.options.checkedLineColor }, attrs: { d: t.options.defaultLineMarker.data } })]), e("marker", { attrs: { id: t.options.instanceId + "-start-arrow-checked", markerWidth: t.options.defaultLineMarker.markerWidth, markerHeight: t.options.defaultLineMarker.markerHeight, refX: t.options.defaultLineMarker.refX, refY: t.options.defaultLineMarker.refY, "marker-units": "strokeWidth", orient: "auto", viewBox: "0 0 12 12" } }, [e("path", { style: { fill: t.options.checkedLineColor }, attrs: { d: t.options.defaultLineMarker.data, transform: "translate(12,12)rotate(180)" } })]), t._l(t.allLineColors, function(o) {
    ...
    return e("SeeksRGNode", { key: o.seeks_id, attrs: { "node-props": o }, scopedSlots: t._u([{ key: "node", fn: function(n) {
      ...
      return [t._t("node-expand-holder", null, { nodeProps: s, expandHolderPosition: a, expandButtonClass: l, color: r, expandOrCollapseNode: c })];
    } }], null, !0) });
  }), 1), e("div", { staticClass: "rel-linediv rel-linediv-el-lines" }, [e("svg", { staticClass: "rel-lines-svg rel-lines-svg-el-lines", attrs: { xmlns: "http://www.w3.org/2000/svg" } }, [t._l(t.graphData.elementLines, function(o) {
    return [o.relations[0].isHide === !1 ? e("RGLineSmart", { key: "ell-" + o.relations[0].id, attrs: { link: o, relation: o.relations[0], "relation-index": 0 } }) : t._e()];
  })], 2)])]);
}, Lo = [];
const At = {};
var bo = /* @__PURE__ */ A(
...
const So = /* @__PURE__ */ function() {
  ...
  components: { RelationGraphSingleGraph: So, SeeksRGNode: Lt, SeeksRGLink: te, SeeksRGLinePath: ee },
  data() {
    return {};
  },
  inject: ["graph"],
  ...
  methods: {
    mouseListener(t) {
      this.relationGraph.onMouseWheel(t);
    },
    onDragStart(t) {
      this.relationGraph.onCanvasDragStart(t);
    },
    contextmenu(t) {
      this.relationGraph.onContextmenu(t);
    }
  }
};
var Po = function() {
  var t = this, i = t.$createElement, e = t._self._c || i;
  return e("div", { staticClass: "rel-map", class: [t.options.layoutClassName, t.options.backgroundImageNoRepeat ? "rel-map-background-norepeat" : void 0], style: { width: "100%", height: "100%", "background-color": t.options.backgroundColor || void 0, "background-image": t.options.backgroundImage ? "url(" + t.options.backgroundImage + ")" : void 0 }, on: { contextmenu: function(o) {
    return o.preventDefault(), t.contextmenu(o);
  }, mousedown: function(o) {
    return !o.type.indexOf("key") && t._k(o.keyCode, "left", 37, o.key, ["Left", "ArrowLeft"]) || "button" in o && o.button !== 0 ? null : (o.stopPropagation(), t.onDragStart(o));
  }, touchstart: function(o) {
    return o.stopPropagation(), t.onDragStart(o);
  }, wheel: t.mouseListener } }, [e("div", { ref: "seeksRGCanvas", staticClass: "rel-map-canvas", style: t.canvasSizeAndPosition }, [e("div", { staticClass: "rel-canvas-slot rel-canvas-slot-behind" }, [t._t("canvas-plug")], 2), e("RelationGraphSingleGraph", { scopedSlots: t._u([{ key: "node", fn: function(o) {
    var n = o.node;
    return [t._t("node", null, { node: n })];
  } }, { key: "line", fn: function(o) {
    var n = o.line, s = o.link;
    return [t._t("line", null, { line: n, link: s })];
    ...
    return [t._t("node-expand-holder", null, { nodeProps: n, expandHolderPosition: s, expandButtonClass: a, color: l, expandOrCollapseNode: r })];
  } }], null, !0) }), e("div", { staticClass: "rel-canvas-slot rel-canvas-slot-above" }, [t._t("canvas-plug-above")], 2)], 1)]);
}, Eo = [];
const Dt = {};
var No = /* @__PURE__ */ A(
  Mo,
...
const To = /* @__PURE__ */ function() {
  ...
  methods: {
    miniViewHeight() {
      let t = 9999, i = -9999, e = 9999, o = -9999;
      for (let n = 0; n < this.graphData.nodes.length; n++) {
        const s = this.graphData.nodes[n];
        s.x < t && (t = s.x), s.x > i && (i = s.x), s.y < e && (e = s.y), s.y > o && (o = s.y);
      }
      return this.viewHeight = (o - e) * this.viewWidth / (i - t), this.minX = t, this.minY = e, this.maxX = i, this.maxY = o, this.viewHeight;
    },
    getPositionData() {
      const t = this.viewWidth / this.options.canvasNVInfo.width, i = this.options.viewNVInfo.width * t, e = this.options.viewNVInfo.height * t;
      let o = (this.options.viewNVInfo.x - this.options.canvasNVInfo.x) * t * (this.options.canvasZoom / 100), n = (this.options.viewNVInfo.y - this.options.canvasNVInfo.y) * t * (this.options.canvasZoom / 100);
...
var Ro = function() {
  ...
  } }, [t._l(t.graphData.nodes, function(o) {
    return [t.isAllowShowNode(o) ? e("div", { key: o.id, staticClass: "c-mini-node", style: {
      left: (o.x - t.minX) * t.viewWidth / (t.maxX - t.minX) + "px",
      top: (o.y - t.minY) * t.viewHeight / (t.maxY - t.minY) + "px"
    } }) : t._e()];
  })], 2)]);
}, Fo = [];
const It = {};
...
const Vo = /* @__PURE__ */ function() {
  ...
  methods: {
    ...
    switchLayout(t) {
      d("change layout:", t), this.relationGraph.switchLayout(t);
    },
    toggleAutoLayout() {
...
var Uo = function() {
  var t = this, i = t.$createElement, e = t._self._c || i;
  return e("div", { staticClass: "c-mini-toolbar", style: { "margin-left": t.options.viewELSize.width - 50 + "px", "margin-top": (t.options.viewELSize.height - 260) / 2 + "px" } }, [e("div", { staticClass: "c-mb-button", staticStyle: { "margin-top": "0px" }, on: { click: function(o) {
    return t.relationGraph.fullscreen();
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-resize-" } })]), e("span", { staticClass: "c-mb-text" }, [t._v(t._s(t.options.fullscreen ? "\u9000\u51FA" : "\u5168\u5C4F"))])]), t.options.allowShowZoomMenu ? e("div", { staticClass: "c-mb-button", on: { click: function(o) {
    ...
    return t.relationGraph.zoom(-20);
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-suoxiao" } })]), e("span", { staticClass: "c-mb-text" }, [t._v("\u7F29\u5C0F")])]) : t._e(), t.options.layouts.length > 1 ? e("div", { staticClass: "c-mb-button" }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-yuanquanfenxiang" } })]), e("span", { staticClass: "c-mb-text" }, [t._v("\u5E03\u5C40")]), e("div", { staticClass: "c-mb-child-panel", style: { width: t.options.layouts.length * 70 + 6 + "px", "margin-left": t.options.layouts.length * -70 - 5 + "px" } }, t._l(t.options.layouts, function(o) {
    return e("div", { key: o.label, staticClass: "c-mb-button c-mb-button-c", class: { "c-mb-button-on": t.options.layoutLabel === o.label }, staticStyle: { width: "70px" }, on: { click: function(n) {
      return t.switchLayout(o);
    } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-yuanquanfenxiang" } })]), e("span", { staticClass: "c-mb-text" }, [t._v(t._s(o.label))])]);
  ...
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-hj2" } })]), e("span", { staticClass: "c-mb-text" }, [t._v("\u76F4\u7EBF")])]), e("div", { staticClass: "c-mb-button c-mb-button-c", class: { "c-mb-button-on": t.options.defaultLineShape === 2 }, staticStyle: { width: "50px" }, on: { click: function(o) {
    return t.relationGraph.setDefaultLineShape(2);
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-lianjieliu" } })]), e("span", { staticClass: "c-mb-text" }, [t._v("\u7B80\u6D01")])]), e("div", { staticClass: "c-mb-button c-mb-button-c", class: { "c-mb-button-on": t.options.defaultLineShape === 6 }, staticStyle: { width: "50px" }, on: { click: function(o) {
    return t.relationGraph.setDefaultLineShape(6);
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-lianjieliu" } })]), e("span", { staticClass: "c-mb-text" }, [t._v("\u751F\u52A8")])]), e("div", { staticClass: "c-mb-button c-mb-button-c", class: { "c-mb-button-on": t.options.defaultLineShape === 5 }, staticStyle: { width: "50px" }, on: { click: function(o) {
    return t.relationGraph.setDefaultLineShape(5);
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-lianjieliu" } })]), e("span", { staticClass: "c-mb-text" }, [t._v("\u9C7C\u5C3E")])]), e("div", { staticClass: "c-mb-button c-mb-button-c", class: { "c-mb-button-on": t.options.defaultLineShape === 4 }, staticStyle: { width: "50px" }, on: { click: function(o) {
    return t.relationGraph.setDefaultLineShape(4);
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-hj2" } })]), e("span", { staticClass: "c-mb-text" }, [t._v("\u6298\u7EBF")])])])]) : t._e(), t.options.allowSwitchJunctionPoint ? e("div", { staticClass: "c-mb-button" }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-lianjie_connecting5" } })]), e("span", { staticClass: "c-mb-text" }, [t._v("\u8FDE\u63A5\u70B9")]), e("div", { staticClass: "c-mb-child-panel", staticStyle: { width: "206px", "margin-left": "-205px" } }, [e("div", { staticClass: "c-mb-button c-mb-button-c", class: { "c-mb-button-on": t.options.defaultJunctionPoint === "border" }, staticStyle: { width: "50px" }, on: { click: function(o) {
    return t.relationGraph.setDefaultJunctionPoint("border");
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-lianjie_connecting5" } })]), e("span", { staticClass: "c-mb-text" }, [t._v("\u8FB9\u7F18")])]), e("div", { staticClass: "c-mb-button c-mb-button-c", class: { "c-mb-button-on": t.options.defaultJunctionPoint === "ltrb" }, staticStyle: { width: "50px" }, on: { click: function(o) {
    return t.relationGraph.setDefaultJunctionPoint("ltrb");
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-lianjie_connecting5" } })]), e("span", { staticClass: "c-mb-text" }, [t._v("\u56DB\u70B9")])]), e("div", { staticClass: "c-mb-button c-mb-button-c", class: { "c-mb-button-on": t.options.defaultJunctionPoint === "tb" }, staticStyle: { width: "50px" }, on: { click: function(o) {
    return t.relationGraph.setDefaultJunctionPoint("tb");
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-lianjie_connecting5" } })]), e("span", { staticClass: "c-mb-text" }, [t._v("\u4E0A\u4E0B")])]), e("div", { staticClass: "c-mb-button c-mb-button-c", class: { "c-mb-button-on": t.options.defaultJunctionPoint === "lr" }, staticStyle: { width: "50px" }, on: { click: function(o) {
  ...
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-tupian" } })]), e("span", { staticClass: "c-mb-text" }, [t._v("PNG")])]), e("div", { staticClass: "c-mb-button c-mb-button-c", staticStyle: { width: "50px" }, on: { click: function(o) {
    return t.relationGraph.downloadAsImage("jpg");
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-tupian" } })]), e("span", { staticClass: "c-mb-text" }, [t._v("JPG")])]), t.relationGraph.listeners.onDownloadExcel ? e("div", { staticClass: "c-mb-button c-mb-button-c", staticStyle: { width: "50px" }, on: { click: function(o) {
...
var Qo = function() {
  var t = this, i = t.$createElement, e = t._self._c || i;
  return e("div", { staticClass: "rel-toolbar", class: ["rel-toolbar-h-" + t.options.toolBarPositionH, "rel-toolbar-v-" + t.options.toolBarPositionV, "rel-toolbar-" + t.options.toolBarDirection] }, [t.options.allowShowFullscreenMenu ? e("div", { staticClass: "c-mb-button", staticStyle: { "margin-top": "0px" }, attrs: { title: "\u5168\u5C4F/\u9000\u51FA\u5168\u5C4F" }, on: { click: function(o) {
    return t.relationGraph.fullscreen();
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-resize-" } })])]) : t._e(), t.options.allowShowZoomMenu ? e("div", { staticClass: "c-mb-button", attrs: { title: "\u653E\u5927" }, on: { click: function(o) {
    return t.relationGraph.zoom(20);
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-fangda" } })])]) : t._e(), t.options.allowShowZoomMenu ? e("div", { staticClass: "c-current-zoom", on: { dblclick: t.zoomToFit } }, [t._v(t._s(t.options.canvasZoom) + "%")]) : t._e(), t.options.allowShowZoomMenu ? e("div", { staticClass: "c-mb-button", staticStyle: { "margin-top": "0px" }, attrs: { title: "\u7F29\u5C0F" }, on: { click: function(o) {
    return t.relationGraph.zoom(-20);
  } } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-suoxiao" } })])]) : t._e(), t.options.allowAutoLayoutIfSupport && t.options.isNeedShowAutoLayoutButton ? e("div", { staticClass: "c-mb-button", class: { "c-mb-button-on": t.options.autoLayouting }, attrs: { title: t.options.autoLayouting ? "\u70B9\u51FB\u505C\u6B62\u81EA\u52A8\u5E03\u5C40" : "\u70B9\u51FB\u5F00\u59CB\u81EA\u52A8\u8C03\u6574\u5E03\u5C40" }, on: { click: t.toggleAutoLayout } }, [t.options.autoLayouting ? e("svg", { staticClass: "c-loading-icon rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-lianjiezhong" } })]) : e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-zidong" } })])]) : t._e(), t.options.allowShowRefreshButton ? e("div", { staticClass: "c-mb-button", attrs: { title: "\u5237\u65B0" }, on: { click: t.refresh } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-ico_reset" } })])]) : t._e(), t.options.allowShowDownloadButton ? e("div", { staticClass: "c-mb-button", attrs: { title: "\u4E0B\u8F7D\u56FE\u7247" }, on: { click: t.downloadAsImage } }, [e("svg", { staticClass: "rg-icon", attrs: { "aria-hidden": "true" } }, [e("use", { attrs: { "xlink:href": "#icon-tupian" } })])]) : t._e(), e("div", { staticStyle: { clear: "both" } })]);
}, Ko = [];
const Ft = {};
var tn = /* @__PURE__ */ A(
  qo,
...
var sn = function() {
  var t = this, i = t.$createElement, e = t._self._c || i;
  return t.options && (t.options.creatingNodePlot || t.options.creatingSelection) ? e("div", { staticClass: "rel-operate" }, [e("div", { staticStyle: { position: "relative" } }, [t.options.creatingNodePlot && t.options.showTemplateNode ? e("SeeksRGNode", { attrs: { "node-props": t.options.newNodeTemplate }, scopedSlots: t._u([{ key: "node", fn: function() {
    return [t._t("node-template", null, { node: t.options.newNodeTemplate })];
  }, proxy: !0 }], null, !0) }) : t._e(), t.options.creatingSelection ? e("div", { staticClass: "rel-selection", style: {
    left: t.options.selectionView.x + "px",
    top: t.options.selectionView.y + "px",
    width: t.options.selectionView.width + "px",
    height: t.options.selectionView.height + "px"
  } }) : t._e()], 1)]) : t._e();
}, an = [];
const Ht = {};
var rn = /* @__PURE__ */ A(
...
const cn = /* @__PURE__ */ function() {
  ...
  onNodeExpand: t.onNodeExpand,
  onNodeCollapse: t.onNodeCollapse,
  onLineClick: t.onLineClick,
  onImageDownload: t.onImageDownload,
  onNodeDragEnd: t.onNodeDragEnd,
  onCanvasDragEnd: t.onCanvasDragEnd,
  beforeChangeLayout: t.beforeChangeLayout,
  onContextmenu: t.onContextmenu,
  onCanvasClick: t.onCanvasClick,
  onCanvasSelectionEnd: t.onCanvasSelectionEnd,
  onImageSaveAsFile: t.onImageSaveAsFile
}), hn = {
  name: "GraphLoading",
  data() {
    return {};
  ...
  methods: {
    clickGraphMask(t) {
      this.relationGraph.clickGraphMask(t);
    }
  }
};
var dn = function() {
...
const _n = /* @__PURE__ */ function() {
  ...
  components: { GraphLoading: _n, GraphOperateStuff: cn, GraphMiniToolBar: Jo, GraphToolBar: on, GraphMiniView: Vo, RGCanvas: zo, GraphDebugPanel: To },
  props: {
    options: {
      mustUseProp: !1,
      default: () => ({}),
  ...
  created() {
    ...
    let t = !1;
    if (!Q || !Q.version || Q.version.startsWith("3")) {
    ...
    Q.version.slice(0, 4) === "2.5." && (t = !0), Q.version.slice(0, 4) === "2.6." && Number.parseInt(Q.version.split(".")[2]) <= 12 && (t = !0), t && (this.oldVueVersion = !0, console.error(`\u60A8\u7684Vue\u7248\u672C\uFF1A${Q.version}\u6CE8\u610F\uFF1A\u5F53\u4F60\u4F7F\u7528\u7684vue\u7248\u672C\u7B49\u4E8E\u4F4E\u4E8E2.6.12\u65F6\uFF0C\u56FE\u8C31\u4F1A\u663E\u793A\u4E0D\u6B63\u5E38\uFF0C\u53C2\u8003\u8FD9\u4E2A\u8FDE\u63A5\u89E3\u51B3\u8FD9\u4E2A\u95EE\u9898\uFF1Ahttps://github.com/seeksdream/relation-graph/issues/113`)), ot || console.error("[relation-graph]Please introduce component screenfull, for example:https://cdnjs.cloudflare.com/ajax/libs/screenfull.js/5.1.0/screenfull.min.js"), Ut || console.error("[relation-graph]Please introduce component html2canvas, for example:https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js");
  },
  mounted() {
    d("---------------------------graph mounted---------------------------");
    const t = this.relationGraphCore ? new this.relationGraphCore(this.options, Wt(this)) : new Qt(this.options, Wt(this));
    t.options.oldVueVersion = this.oldVueVersion, t.setReactiveData(this.graphData, this.graph), t.setDom(this.$refs.seeksRelationGraph), t.ready(), this.graph.instance = t, ot && ot.on && ot.on("change", this.onFullscreen);
  },
  beforeUnmount() {
    d("---------------------------graph beforeDestroy---------------------------"), ot.off("change", this.onFullscreen), this.$refs.seeksRelationGraph.remove();
  },
  updated() {
    d("---------------------------graph updated---------------------------");
  },
  methods: {
    onFullscreen() {
      this.graph.instance.fullscreen(ot.isFullscreen);
    },
    getInstance() {
      return this.graph.instance;
    },
    setOptions(t, i) {
      return x(this, null, function* () {
        yield this.graph.instance.setOptions(t), i && i(this.graph.instance);
      });
    },
    setJsonData(o, n, s) {
      return x(this, arguments, function* (t, i, e) {
        return arguments.length === 2 && typeof i == "function" && (e = i, i = !0), yield this.graph.instance.setJsonData(t, i), new Promise((a, l) => {
          this.$nextTick(() => x(this, null, function* () {
            yield this.graph.instance.refresh(!1), e && e(this.graph.instance), a();
          }));
        });
      });
    },
    appendJsonData(o, n, s) {
      return x(this, arguments, function* (t, i, e) {
        arguments.length === 2 && typeof i == "function" && (e = i, i = !0), yield this.graph.instance.appendJsonData(t, i), e && e(this.graph.instance);
      });
    },
    setLayouter(t) {
      this.graph.instance.setLayouter(t);
    },
    onGraphResize() {
    ...
    focusNodeById(t) {
      return x(this, null, function* () {
        return yield this.graph.instance.focusNodeById(t);
      });
    },
    getNodeById(t) {
      return this.graph.instance.getNodeById(t);
    },
    removeNodeById(t) {
      return this.graph.instance.removeNodeById(t);
    },
    getNodes() {
  ...
  beforeDestroy() {
    d("beforeDestroy:relation-graph"), this.graph.instance.options.instanceDestroyed = !0;
  }
};
var gn = function() {
  var t = this, i = t.$createElement, e = t._self._c || i;
  return e("div", { ref: "seeksRelationGraph", staticClass: "relation-graph", style: { width: "100%", height: "100%" } }, [t.graph.instance && t.graph.options ? [t.graph.options.showDebugPanel ? e("GraphDebugPanel") : t._e(), t.graph.options.allowShowMiniToolBar === !0 ? [t.graph.options.oldVueVersion && !t.graph.options.ovUseToolbarSlot ? e("GraphToolBar") : t._t("tool-bar", function() {
    return [t.graph.options.toolBarVersion === "v2" ? e("GraphToolBar") : e("GraphMiniToolBar")];
  })] : t._e(), t.graph.options.allowShowMiniView === !0 ? t._t("mini-view", function() {
    return [e("GraphMiniView")];
  }) : t._e(), t._t("graph-plug"), e("RGCanvas", { scopedSlots: t._u([{ key: "node", fn: function(o) {
    var n = o.node;
    return [t._t("node", null, { node: n })];
  } }, { key: "line", fn: function(o) {
    var n = o.line, s = o.link;
    ...
    return [t._t("canvas-plug")];
  }, proxy: !0 }, { key: "canvas-plug-above", fn: function() {
    return [t._t("default")];
  }, proxy: !0 }, { key: "node-expand-holder", fn: function(o) {
    var n = o.nodeProps, s = o.expandHolderPosition, a = o.expandButtonClass, l = o.color, r = o.expandOrCollapseNode;
    return [t._t("node-expand-holder", null, { nodeProps: n, expandHolderPosition: s, expandButtonClass: a, color: l, expandOrCollapseNode: r })];
  } }], null, !0) }), e("GraphOperateStuff", { scopedSlots: t._u([{ key: "node-template", fn: function(o) {
    var n = o.node;
    return [t._t("node-template", null, { node: n })];
  } }], null, !0) }), e("GraphLoading")] : t._e()], 2);
}, yn = [];
const jt = {};
var vn = /* @__PURE__ */ A(
  mn,
...
const oe = /* @__PURE__ */ function() {
  ...
  BidirectionalTreeLayouter: Yt,
  CenterLayouter: Zt,
  CircleLayouter: Jt,
  FixedLayouter: qt,
  ForceLayouter: it
}, Pn = Ce, En = ke, Nn = ye, On = _e, zn = B, Gn = ve, Bn = Ge, $n = rt, ne = (t, i) => {
  t.component("RelationGraph", oe);
};
typeof window != "undefined" && window.Vue && ne(window.Vue);
const wn = oe, An = St(kt({}, wn), {
  version: Xt,
  install: ne
});
export {
  ...
  Nn as RGLinkUtils,
  On as RGNodeUtils,
  Gn as RGNodesAnalyticUtils,
  En as RGOptionsUtils,
  Sn as RelationGraphCore,
  An as default
};
